...
En el siguiente cuadro se describe las acciones realizadas y enunciados de conclusiones por parte del grupo, que permiten sustentar el haber alcanzado el logro del ABET – EAC - Student Outcome 4 a lo largo de todo el proyecto.

| Criterio Específico | Integrante | Acciones Realizadas |
|---|---|---|
| 4.c.1 Reconoce la responsabilidad ética y profesional | Alva Abanto, Luis Andrés | Reconoció su responsabilidad profesional al proteger la privacidad y seguridad de los usuarios en el diseño de las políticas de uso, en la implementación de la autenticación y en la gestión segura de credenciales dentro de los pipelines de despliegue de la aplicación. |
| | Binda Arbañil, Marcelo Alejandro | Asumió su responsabilidad profesional al automatizar los procesos de despliegue con mecanismos de control y reversión, y al mantener la trazabilidad honesta del trabajo del equipo en los distintos sprints del proyecto. |
| | Castillo Garay, Ainhoa Lucía | Reconoció su responsabilidad ética al aplicar principios de diseño inclusivo y accesible en la aplicación móvil, al proteger el anonimato de los usuarios durante los procesos de validación, y al conducir la experimentación con hipótesis verificables y un reporte honesto de los resultados obtenidos, sin manipular la evidencia para justificar decisiones ya tomadas. |
| | Martel Andrade, Cassius Estefano | Estableció desde el inicio restricciones éticas claras para el manejo de datos sensibles de los usuarios, y lideró la priorización responsable de la investigación con los clientes, evitando experimentar de forma arbitraria con las personas involucradas. |
| | Nakamurakare Teruya, Alex Tomio | Condujo la investigación con usuarios bajo principios de consentimiento informado y protección de su identidad, y estableció y supervisó el principio de "no causar daño" en la experimentación con funcionalidades financieras simuladas de la aplicación. |
| | Yalán Zhang, Angie Christina | Evitó sesgar la representación de los usuarios al construir los perfiles del público objetivo con base en información real, y reportó con honestidad los hallazgos desfavorables del proyecto en lugar de omitir o suavizar evidencia que comprometiera su imagen. |
| 4.c.2 Emite juicios informados considerando el impacto global, económico, ambiental y social | Alva Abanto, Luis Andrés | Emitió juicios informados sobre el impacto social de la problemática abordada por el proyecto y sobre las implicancias económicas de las decisiones de infraestructura y distribución de la aplicación. |
| | Binda Arbañil, Marcelo Alejandro | Analizó el impacto económico y ambiental de las decisiones de infraestructura en la nube, y evaluó el costo-beneficio operativo de escalar nuevas funcionalidades a producción considerando su valor social para los usuarios. |
| | Castillo Garay, Ainhoa Lucía | Justificó decisiones de diseño considerando el contexto socioeconómico de los usuarios objetivo, y evaluó de forma crítica el impacto social y de negocio de los resultados de validación, evitando sobreestimar el efecto de las soluciones implementadas y priorizando responsablemente los esfuerzos futuros frente a las necesidades reales del negocio y de los usuarios. |
| | Martel Andrade, Cassius Estefano | Emitió juicios informados sobre las implicancias económicas y de equidad de acceso derivadas de las limitaciones logísticas del servicio, y sustentó con evidencia real las decisiones de priorización de funcionalidades con mayor impacto sobre los ingresos del negocio. |
| | Nakamurakare Teruya, Alex Tomio | Analizó el impacto social de la relevancia del proyecto en su contexto, así como las implicancias ambientales y sociales de decisiones técnicas y de producto, ponderando beneficios frente a riesgos para los usuarios. |
| | Yalán Zhang, Angie Christina | Sustentó con datos reales el potencial impacto social del producto en distintos segmentos de usuarios, y evaluó críticamente la relación entre el interés declarado y el valor real percibido por los usuarios para orientar decisiones futuras del proyecto. |

**Conclusiones generales (por criterio, a lo largo de todo el proyecto):**

| Criterio | Conclusión |
|---|---|
| 4.c.1 | A lo largo de todo el proyecto, el equipo demostró un desarrollo progresivo de su responsabilidad ética y profesional: incorporó desde etapas tempranas principios de privacidad, accesibilidad e inclusión digital, implementó mecanismos concretos para proteger a los usuarios tanto en el producto como en su operación en producción, y consolidó estas prácticas en la experimentación con usuarios reales, reportando siempre con honestidad los resultados obtenidos, incluyendo hallazgos desfavorables o brechas aún no resueltas. |
| 4.c.2 | El equipo evidenció a lo largo del proyecto una capacidad creciente de emitir juicios informados fundamentados en evidencia real, conectando de forma consistente las decisiones técnicas y de negocio con su impacto económico, social y ambiental sobre los usuarios y el entorno del producto, y evitando sobreestimar el efecto de las soluciones propuestas al priorizar los recursos del equipo frente a las verdaderas necesidades del negocio y de los usuarios. |


| Criterio Específico | Acciones Realizadas | Conclusiones |
|---|---|---|
| 4.c.1 **Reconoce la responsabilidad ética y profesional en situaciones de ingeniería de software** | **Luis Andres Alva Abanto** <br> **TB1** <br> Redactó los términos y condiciones de uso de Livria, asegurando que el contenido reflejara principios éticos de transparencia y protección al usuario, incluyendo políticas de privacidad de datos y derechos del consumidor digital. <br><br> **TP1** <br> Participó en la implementación del módulo de autenticación, asegurando el almacenamiento seguro de contraseñas mediante hashing y el uso de JWT, reconociendo la responsabilidad profesional de proteger los datos de los usuarios de la plataforma. <br><br> **TB2** <br> Configuró el pipeline de Continuous Integration y Delivery (Secciones 7.1 y 7.2), asegurando que las credenciales de Azure (`AZURE_WEBAPP_PUBLISH_PROFILE`) y las claves de firma de los APKs se mantuvieran exclusivamente en GitHub Secrets, reconociendo que la exposición accidental de estos artefactos compromete la seguridad de toda la plataforma y la confianza de los usuarios. <br><br> **TF1** <br> Documentó la evidencia técnica del pipeline de CI/CD ejecutado sobre la rama de experimentación (8.3.3.4/8.3.3.5), garantizando que los despliegues de las nuevas funcionalidades (billetera, swipe, multimedia) no comprometieran la seguridad de los datos ya protegidos en producción. <br><br> **Marcelo Alejandro Binda Arbañil** <br> **TB1** <br> Elaboró el análisis competitivo del mercado identificando prácticas de negocio responsables en plataformas similares, y propuso estrategias que priorizan el acceso equitativo a la lectura como valor social. <br><br> **TP1** <br> Implementó el pipeline de CI/CD con GitHub Actions, documentando las decisiones técnicas tomadas y asegurando que el proceso de despliegue automatizado cumpliera con estándares de calidad y no introdujera regresiones en producción. <br><br> **TB2** <br> Diseñó el mecanismo de Rollback y el Approval Gate del pipeline de Continuous Deployment (Sección 7.3), reconociendo la responsabilidad profesional de proteger a los usuarios finales de Livria ante un despliegue defectuoso en producción mediante aprobaciones manuales y reversión instantánea del entorno. <br><br> **TF1** <br> Verificó que el registro de commits del Sprint 4 (8.3.3.1) reflejara con transparencia el trabajo real ejecutado, evitando atribuciones incorrectas de autoría entre los Work-Items del sprint backlog To-Be. <br><br> **Ainhoa Lucía Castillo Garay** <br> **TB1** <br> Diseñó los wireframes y mockups de la aplicación aplicando principios de diseño inclusivo (contraste WCAG AA, tamaños de toque adecuados), reconociendo que el software debe ser accesible para usuarios con distintas capacidades. <br><br> **TP1** <br> Desarrolló las pruebas unitarias del módulo de comunidades, documentando los casos de prueba para garantizar que las funcionalidades sociales de la plataforma operaran de forma íntegra y sin exponer datos privados de los usuarios. <br><br> **TB2** <br> Diseñó y administró el instrumento de Validation Interviews (Sección 6.3), garantizando el anonimato de los 28 participantes en las respuestas recolectadas y utilizando los datos exclusivamente para fines de mejora del producto, reconociendo la responsabilidad ética de manejar con cuidado la información de usuarios reales durante la validación cuantitativa. <br><br> **TF1** <br> Diseñó y desarrolló las cinco Experiment Cards del backlog de experimentación (8.3.1), asegurando que cada hipótesis (H01-H05) incluyera un criterio de éxito medible y verificable antes de involucrar a usuarios reales, evitando experimentar de forma arbitraria. Redactó las To-Be User Stories con criterios de aceptación Given-When-Then para las cinco funcionalidades (localización, swipe, billetera, vitrina literaria, multimedia), documentando el Sprint 4 completo con sus Work-Items y estimaciones. Diseñó el instrumento de Validation Interviews To-Be (8.3.4.1) replicando la escala Likert de la ronda As-Is para permitir un contraste ético y metodológicamente válido, y condujo el análisis de las 28 respuestas reales recolectadas (8.4.1), reportando con honestidad tanto los resultados favorables como las brechas pendientes de medición conductual (H02 y H05), sin inflar artificialmente el cumplimiento de los criterios de éxito. Actualizó el Question Backlog (8.4.2) reconociendo qué preguntas quedaban resueltas y cuáles debían re-priorizarse tras la evidencia obtenida. <br><br> **Cassius Estefano Martel Andrade** <br> **TB1** <br> Lideró la definición del alcance del proyecto, estableciendo explícitamente las restricciones éticas del sistema, como la no recolección de datos bancarios directos y la verificación del procesamiento de pagos con EmailJS <br><br> **TP1** <br> Coordinó la integración del backend con las aplicaciones móviles, verificando que los endpoints expuestos no filtraran información sensible de los usuarios en las respuestas de la API, aplicando buenas prácticas de seguridad profesional. <br><br> **TB2** <br> Lideró la construcción del Question Backlog (Sección 8.1.4), estableciendo un sistema de priorización objetivo basado en Confianza, Riesgo, Impacto e Interés, reconociendo la responsabilidad profesional de no experimentar arbitrariamente con los usuarios sino de priorizar primero las preguntas de mayor riesgo para el negocio y la experiencia del lector. <br><br> **TF1** <br> Documentó las decisiones arquitectónicas del backend en el contexto de las nuevas funcionalidades experimentales (8.3.3.5), reconociendo la responsabilidad de mantener la integridad de los endpoints de Orders y Wallet ante la carga de pruebas de usuario. <br><br> **Alex Tomio Nakamurakare Teruya** <br> **TB1** <br> Realizó las entrevistas de needfinding siguiendo principios éticos de investigación: obtuvo consentimiento informado de los participantes, protegió su identidad en el informe y utilizó la información únicamente para los fines declarados del proyecto. <br><br> **TP1** <br> Implementó las pruebas de integración del sistema de autenticación, reconociendo la responsabilidad profesional de garantizar que el acceso a la plataforma sea seguro y que las credenciales de los usuarios estén correctamente protegidas en todo momento. <br><br> **TB2** <br> Redactó las Consideraciones Éticas (Do No Harm) del diseño de experimentos (Sección 8.2.6), estableciendo que jamás se experimentará con los precios reales de los libros y que la Billetera Livria operará en modo simulación durante las pruebas de usabilidad, reconociendo la responsabilidad profesional de no causar daño económico ni psicológico a los usuarios durante la fase de experimentación. <br><br> **TF1** <br> Supervisó que las pruebas de la Billetera Livria en la ronda de validación (8.3.4) se mantuvieran en modo simulación, reforzando el principio de Do No Harm ya establecido en TB2 para evitar cualquier riesgo económico real a los participantes. <br><br> **Angie Christina Yalán Zhang** <br> **TB1** <br> Elaboró los User Personas y Empathy Maps basándose en datos reales recolectados en entrevistas, evitando generalizaciones que pudieran sesgar el diseño del producto y comprometer la representación justa de los segmentos objetivo. <br><br> **TP1** <br> Colaboró en la documentación de los endpoints RESTful con Swagger, asegurando que la interfaz pública de la API fuera clara, completa y no expusiera operaciones no autorizadas, cumpliendo con su responsabilidad profesional en el diseño de servicios seguros. <br><br> **TB2** <br> Interpretó los resultados del instrumento de Validation Interviews (Sección 6.3.2), reportando con honestidad hallazgos desfavorables para el producto —como el NPS negativo (-17.9) y la baja precisión percibida del motor de recomendaciones— en lugar de omitir o suavizar evidencia que comprometiera la imagen del proyecto, reconociendo que la integridad en el reporte de datos es una responsabilidad profesional ineludible. <br><br> **TF1** <br> Contribuyó a la redacción del Team Collaboration Insights (8.3.3.6), documentando con transparencia las dificultades de coordinación del equipo durante el Sprint 4 sin omitir los aprendizajes negativos del proceso. | **TB1** <br> El equipo demostró reconocer su responsabilidad ética al incorporar desde las etapas tempranas del proyecto consideraciones sobre privacidad de datos, accesibilidad e inclusión digital. La redacción de términos y condiciones, el diseño inclusivo de la interfaz y el manejo responsable de la información recolectada en entrevistas evidencian que el grupo comprende que el ejercicio de la ingeniería de software conlleva obligaciones hacia los usuarios y la sociedad. <br><br> **TP1** <br> Durante esta entrega el equipo consolidó su responsabilidad ética y profesional a través de la implementación de mecanismos de seguridad concretos: cifrado de contraseñas, uso de JWT, validación de entradas y pipelines de calidad automatizados. Estas decisiones técnicas reflejan la comprensión de que proteger a los usuarios no es opcional, sino una obligación inherente al rol del ingeniero de software. <br><br> **TB2** <br> En esta entrega el equipo extendió su responsabilidad ética y profesional hacia dos nuevos frentes: la operación continua del sistema en producción (DevOps) y la experimentación directa con usuarios reales (Capítulo VIII). La protección de credenciales y mecanismos de rollback en los pipelines de despliegue, el diseño éticamente cuidado del instrumento de validación, la priorización responsable de las preguntas de experimentación, el principio explícito de "Do No Harm" en las pruebas con la Billetera Livria, y la honestidad al reportar resultados desfavorables como el NPS negativo, evidencian que el equipo entiende que la responsabilidad profesional no termina en el código, sino que se extiende a cómo se opera el sistema y cómo se trata a los usuarios que participan en su validación. <br><br> **TF1** <br> En esta entrega el equipo consolidó su responsabilidad ética y profesional al someter las cinco apuestas To-Be a un proceso experimental riguroso antes de comprometerlas al roadmap definitivo: el diseño de hipótesis verificables, la ejecución de entrevistas de validación bajo los mismos principios de anonimato y consentimiento ya establecidos, y el reporte honesto de resultados —incluyendo las brechas entre percepción y comportamiento real en H02 y H05— evidencian que el grupo no manipuló la evidencia para justificar decisiones ya tomadas, sino que utilizó el método científico de Lean Startup como una obligación profesional ineludible frente a los usuarios y al propio proyecto. |
| 4.c.2 **Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales** | **Luis Andres Alva Abanto** <br> **TB1** <br> Fundamentó la problemática del proyecto con estadísticas de la Encuesta Nacional de Lectura 2022, emitiendo un juicio informado sobre el impacto social de la baja tasa lectora en el Perú y cómo una solución digital puede contribuir a revertirla. <br><br> **TP1** <br> Evaluó el impacto económico del modelo de suscripción de Livria en el acceso a la lectura, argumentando que el plan gratuito base permite democratizar el acceso al catálogo sin excluir a usuarios de menores recursos. <br><br> **TB2** <br> Evaluó las implicancias económicas de distribuir las aplicaciones móviles mediante GitHub Releases y Firebase App Distribution en lugar de las tiendas oficiales (Sección 7.2), argumentando que esta decisión reduce costos de publicación en una etapa de MVP sin sacrificar la capacidad de actualización continua del producto. <br><br> **TF1** <br> Evaluó el impacto económico de mantener el pipeline de despliegue continuo activo durante la fase experimental (8.3.3.5), argumentando que la estabilidad del backend es crítica para no distorsionar los resultados de la validación con fallos técnicos ajenos a las hipótesis evaluadas. <br><br> **Marcelo Alejandro Binda Arbañil** <br> **TB1** <br> Realizó el análisis FODA comparativo con competidores como Crisol e Ibero, emitiendo juicios sobre las brechas del mercado peruano de libros digitales y el impacto económico que una plataforma móvil accesible puede tener en la industria editorial local. <br><br> **TP1** <br> Analizó las implicancias del despliegue en Azure frente a alternativas locales, considerando factores como costo operativo, disponibilidad del servicio y la huella ambiental asociada al uso de infraestructura en la nube. <br><br> **TB2** <br> Evaluó el impacto operativo y económico de los umbrales de alerta definidos en Azure Monitor (Sección 7.4.3), como el límite de 99.5% de disponibilidad y 5% de errores HTTP 5xx, argumentando que detectar fallos críticos a tiempo previene pérdidas económicas mayores derivadas de un backend caído durante transacciones de pago reales. <br><br> **TF1** <br> Analizó el impacto operativo de escalar los cinco experimentos a producción (8.3.3), considerando el costo de mantenimiento de funcionalidades como la billetera virtual frente al beneficio social de reducir la fricción de pago para usuarios sin experiencia bancaria digital. <br><br> **Ainhoa Lucía Castillo Garay** <br> **TB1** <br> Justificó las decisiones de diseño de la interfaz considerando el contexto socioeconómico de los usuarios objetivo, optando por una interfaz ligera y compatible con dispositivos de gama media para no excluir a usuarios con hardware limitado. <br><br> **TP1** <br> Argumentó la importancia de las pruebas de comportamiento (BDD) en el contexto de una plataforma de comercio electrónico, señalando que fallos en los flujos de compra generan impacto económico directo en los usuarios y pérdida de confianza en el servicio. <br><br> **TB2** <br> Analizó el impacto social de los hallazgos del instrumento de validación (Sección 6.3.2), argumentando que el bajo NPS (-17.9) y la alta confusión percibida en el módulo de comunidades reflejan una brecha real de accesibilidad cognitiva que, de no corregirse, podría excluir a segmentos de lectores jóvenes menos familiarizados con interfaces sociales complejas. <br><br> **TF1** <br> Emitió un juicio informado sobre el impacto social y de negocio de los resultados obtenidos en la ronda To-Be (8.4.1), contrastando cuantitativamente cada hipótesis contra su respectivo baseline As-Is: argumentó que la mejora del NPS de -17.9 a +39.3 no debe interpretarse como validación absoluta, sino que hipótesis como H02 (swipe) y H05 (multimedia) presentan una brecha entre percepción declarada y comportamiento real aún no instrumentado, evitando así sobreestimar el impacto social y económico de las funcionalidades ante el equipo y los stakeholders. Al re-priorizar el Question Backlog (8.4.2), argumentó por qué ciertas preguntas de impacto económico directo (como el monto óptimo de recarga de la billetera, EXQ08) debían escalar en prioridad antes de comprometer recursos de desarrollo en funcionalidades sociales de menor urgencia, demostrando una asignación responsable de esfuerzo de ingeniería frente a las verdaderas necesidades del negocio y de los usuarios. <br><br> **Cassius Estefano Martel Andrade** <br> **TB1** <br> Definió los Business Goals del Impact Mapping con criterios SMART, emitiendo juicios sobre metas de crecimiento realistas para el contexto latinoamericano y considerando las barreras de adopción tecnológica presentes en la región. <br><br> **TP1** <br> Evaluó el impacto de implementar entregas a domicilio únicamente en Lima Metropolitana, reconociendo las limitaciones logísticas actuales y su efecto en la equidad de acceso al servicio para usuarios de provincias. <br><br> **TB2** <br> Emitió un juicio informado sobre el impacto económico de la fricción en el embudo de pagos (Sección 8.1.1), argumentando con evidencia del Experimento 2 que un proceso de transferencia manual de 3 a 8 minutos representa una barrera de conversión que afecta directamente los ingresos de Livria y la equidad de acceso para usuarios sin experiencia previa en operaciones bancarias digitales. <br><br> **TF1** <br> Evaluó el impacto económico de priorizar la Billetera Livria (H03) sobre otras apuestas To-Be, argumentando con la evidencia de la Pregunta 14 del As-Is que el método de pago manual era el principal cuello de botella de conversión del embudo de ventas. <br><br> **Alex Tomio Nakamurakare Teruya** <br> **TB1** <br> Analizó estudios sobre el impacto del uso de TikTok en el rendimiento académico de estudiantes peruanos para fundamentar la relevancia social del proyecto, emitiendo un juicio informado sobre la relación entre el consumo de contenido digital breve y el declive del hábito lector. <br><br> **TP1** <br> Consideró el impacto ambiental del almacenamiento de imágenes en formato Base64 dentro de la base de datos versus el uso de servicios de almacenamiento en la nube, argumentando sobre la eficiencia de recursos y la sostenibilidad técnica de la solución a largo plazo. <br><br> **TB2** <br> Argumentó las consecuencias sociales de habilitar contenido multimedia (GIFs) en las comunidades de Livria (Sección 8.2.6), considerando tanto el impacto positivo en la expresividad de los debates literarios como el riesgo de exposición a contenido inapropiado, lo que sustentó la decisión de activar filtros de contenido estricto en la API proveedora de GIFs. <br><br> **TF1** <br> Argumentó las implicancias sociales de habilitar contenido multimedia en comunidades tras observar los resultados reales de H05, ponderando el beneficio de expresividad frente al riesgo de exposición a contenido inapropiado ya anticipado en el diseño de experimentos. <br><br> **Angie Christina Yalán Zhang** <br> **TB1** <br> Sustentó la segmentación del mercado con datos estadísticos de la Encuesta Nacional de Lectura y reportes de Statista sobre comunidades lectoras digitales, emitiendo juicios informados sobre el potencial de impacto social de Livria en distintos grupos etarios y socioeconómicos. <br><br> **TP1** <br> Evaluó las implicancias del uso de Flutter como framework multiplataforma, argumentando que la elección reduce la brecha de acceso tecnológico al permitir que una sola base de código llegue tanto a dispositivos Android de gama baja como a los de gama alta, maximizando el alcance social de la solución. <br><br> **TB2** <br> Evaluó el impacto social de la desconexión observada entre el interés declarado por las comunidades (35.7%, la funcionalidad favorita) y su baja capacidad real de motivar la lectura (media 2.93/5), argumentando que esta brecha representa una oportunidad social desaprovechada que, de cerrarse mediante las apuestas To-Be del Capítulo VIII, podría consolidar a Livria como un motor genuino de fomento lector y no solo de venta de libros. <br><br> **TF1** <br> Interpretó el salto del NPS (-17.9 a +39.3) como evidencia del impacto social agregado de los cinco experimentos, argumentando que la mejora refleja un producto más inclusivo para el segmento de "Lectores en Desarrollo", sin dejar de señalar que ciertas mejoras (H02, H05) requieren aún validación conductual antes de asumirse como definitivas. | **TB1** <br> A lo largo de esta entrega el equipo emitió juicios informados sustentados en datos estadísticos reales sobre la problemática lectora en el Perú, las condiciones del mercado digital latinoamericano y las características socioeconómicas de los segmentos objetivo. Estas decisiones evidencian que el grupo comprende que el software que desarrollan tiene un impacto concreto en el acceso a la cultura y la educación, y que las decisiones de diseño y negocio deben tomarse con responsabilidad y sustento empírico. <br><br> **TP1** <br> En esta entrega el equipo demostró madurez en la emisión de juicios informados al evaluar las consecuencias de sus decisiones técnicas y de negocio desde múltiples perspectivas: el impacto económico del modelo de suscripción en la accesibilidad, las implicancias ambientales de las decisiones de infraestructura, y el efecto social de las restricciones de cobertura geográfica. Estos juicios, respaldados por argumentos técnicos y contextuales, reflejan una visión de ingeniería responsable y orientada al bienestar colectivo. <br><br> **TB2** <br> En esta entrega el equipo amplió su capacidad de emitir juicios informados al conectar evidencia cuantitativa real —obtenida del instrumento de validación con 28 usuarios— con decisiones de negocio, operación e ingeniería: el costo económico de la fricción en el embudo de pagos, el riesgo social de la confusión en comunidades, el impacto operativo de los umbrales de alerta en producción, y la oportunidad social desaprovechada en el módulo de comunidades. Esto demuestra que el equipo es capaz de fundamentar sus decisiones no solo en supuestos iniciales, sino en datos empíricos recolectados directamente de su público objetivo, cerrando el ciclo entre la intuición de negocio y la evidencia medible. <br><br> **TF1** <br> El equipo demostró juicio informado al conectar la evidencia cuantitativa de la ronda As-Is con los resultados de la ronda To-Be de forma comparativa y no aislada: cuantificó el impacto económico de la fricción de pago resuelta por la billetera, el impacto social del giro en la percepción del módulo de perfil, y explícitamente identificó qué mejoras (H01, H03, H04) están sólidamente validadas frente a cuáles (H02, H05) requieren instrumentación adicional antes de asumir su impacto como definitivo, evitando así comprometer recursos de ingeniería en base a conclusiones prematuras. |
...
[ view_community_detail ] ─┤
                           └──► [ comment_in_community ] (Rol: Espectador)
```
...
[ active_user_session ] ───┤
                           └──► [ ui_error_validation ] (Fricción por bloqueo de UI)
```
...
#### A. User Flows Evaluados por Segmento
...
### 8.1.1. As-Is Summary
Livria es una plataforma móvil dirigida al lector peruano contemporáneo que integra en una sola aplicación Flutter tres grandes áreas de valor: un catálogo de libros con sistema de compra mediante transferencia bancaria, un motor de recomendaciones personalizado basado en favoritos y exclusiones, y un módulo social de comunidades literarias segmentadas por género. El backend opera sobre .NET 9 en Azure App Service, con persistencia en base de datos relacional y monitoreo continuo via Azure Application Insights y Firebase Analytics.

Sin embargo, tras los experimentos de analítica instrumentados en los flujos principales (checkout, recomendaciones y comunidades), se han identificado cinco zonas críticas de fricción que degradan la experiencia del usuario y limitan el crecimiento orgánico de la plataforma:

**Problemas identificados:**

* **Barrera Idiomática y Carga Cognitiva:** La totalidad de la interfaz de usuario — incluyendo botones de acción, etiquetas de formularios, mensajes de error, estados vacíos y el flujo de checkout de tres pasos — está implementada en inglés. Para el segmento objetivo de lectores peruanos, en su mayoría hispanohablantes nativos, esta decisión impone una capa de esfuerzo cognitivo innecesario en cada interacción, desde leer "SUBMIT ORDER" hasta interpretar "ADD TO CART" o "PICK UP IN STORE". Esta fricción lingüística es especialmente crítica en pantallas de alta intención como el checkout, donde la confusión puede traducirse directamente en abandono.
* **Fricción Severa en el Embudo de Pagos:** El modelo de pago actual exige que el usuario interrumpa completamente su sesión en la app para acceder a su aplicación bancaria, realizar una transferencia manual al CCI de Livria, capturar una screenshot del comprobante y subirla nuevamente a la app. Este proceso, que puede tomar entre 3 y 8 minutos, debe repetirse íntegramente con cada compra individual. La evidencia del evento `add_payment_info` vs. `purchase` en el Experimento 2 señala este paso como el principal cuello de botella del embudo de conversión.
* **Descubrimiento de Libros Estático y Costoso:** El sistema actual de recomendaciones presenta una cuadrícula fija de libros sugeridos que el usuario debe explorar uno por uno: entrar a la ficha técnica, leer la sinopsis, y luego marcar el libro como favorito o excluido mediante íconos de bookmark y remoción. Este flujo de retroalimentación, medido en el Experimento 7 (CTR de recomendaciones), requiere múltiples taps por decisión, desincentivando la alimentación continua del algoritmo y reduciendo la cantidad de señales de preferencia disponibles para la personalización.
* **Perfiles sin Identidad ni Trayectoria Literaria:** Los perfiles de usuario en Livria actualmente exponen únicamente los datos básicos de cuenta (nombre de usuario, avatar, suscripción) y el historial de órdenes de compra. No existe ninguna sección pública que refleje el recorrido literario del usuario: qué libros ha leído, qué reseñas ha escrito o qué géneros predominan en su historial. Esta ausencia elimina el componente de identidad social que en plataformas similares actúa como principal motor de retención a largo plazo y de conexión entre usuarios dentro de las comunidades.
* **Comunidades Limitadas a Texto Plano:** Aunque el módulo de comunidades permite publicar posts y comentarios con imagen adjunta, la experiencia de los hilos de conversación carece de soporte expresivo para contenidos dinámicos como GIFs animados, que son el formato de comunicación dominante en las comunidades digitales modernas. Esta limitación hace que los debates literarios se perciban rígidos y menos atractivos que otras plataformas sociales de referencia para el segmento objetivo.

**Objetivos de mejora:**

* **Localización Total:** Migrar la interfaz completa al español para eliminar la barrera lingüística en todos los flujos de la app, priorizando las pantallas de checkout, catálogo y comunidades.
* **Centralización de Fondos:** Introducir una billetera virtual interna que permita al usuario realizar una única transferencia para múltiples compras futuras, eliminando el proceso de CCI repetitivo.
* **Gamificación del Descubrimiento:** Rediseñar el motor de recomendaciones hacia una mecánica de swipe instintiva que maximice la recolección de señales de preferencia por sesión con el mínimo esfuerzo del usuario.
* **Construcción de Identidad Literaria:** Crear una sección pública de perfil que exponga el historial de libros leídos y reseñas publicadas, convirtiendo el perfil en un portafolio literario social.
...
3. **Superioridad de la Mecánica de Swipe sobre el Grid Estático:** Se asume que una interacción de deslizamiento (swipe) resulta más natural e instintiva para los usuarios jóvenes que hacer clic en íconos dentro de una cuadrícula, aumentando tanto el volumen de retroalimentación como la satisfacción percibida del motor de recomendaciones.
4. **Proyección de Identidad Literaria como Motor de Retención:** Se asume que para el lector activo, compartir públicamente su historial de libros leídos genera un incentivo de estatus social equivalente al de otras redes culturales (Letterboxd, Goodreads), y que este mecanismo puede replicarse exitosamente dentro de Livria.
5. **Multimedia Eleva la Calidad Percibida de los Debates Literarios:** Se asume que el formato GIF y las imágenes en interacciones sociales no trivializa las discusiones sobre libros sino que las enriquece, permitiendo expresar reacciones emocionales ante un pasaje o personaje de forma más precisa que el texto plano.
6. **El Umbral de Confianza para la Billetera Livria es Alcanzable:** Se asume que, aunque Livria es una plataforma nueva, el historial de transacciones exitosas mediante CCI genera suficiente confianza como para que el usuario dé el paso de inmovilizar fondos en una billetera virtual interna.
7. **La Localización Impacta Más en Checkout que en Catálogo:** Se asume que la barrera idiomática genera mayor fricción en las pantallas de acción (checkout, validaciones de formulario) que en las de exploración pasiva (catálogo, sinopsis), porque en las primeras el usuario debe leer y actuar simultáneamente.
8. **Frecuencia de lectura:** Se asume que a mayor interacción social en la app, el usuario lee más libros al mes.
...
3. **Calidad vs. Cantidad en Recomendaciones:** No sabemos si al reducir el tiempo de decisión mediante swipe, los usuarios comenzarán a descartar libros valiosos basándose únicamente en la portada o el título, deteriorando la calidad de las señales de preferencia que alimentan el algoritmo.
4. **Impacto Real de Perfiles Públicos:** Carecemos de datos sobre si la habilitación de un historial de lectura público efectivamente incrementa las visitas entre perfiles, la tasa de unión a nuevas comunidades o las compras inspiradas en el catálogo de otro usuario.
5. **Riesgo de Saturación Visual por Multimedia en Foros:** No tenemos certeza sobre si las imágenes o GIFs en los hilos de discusión derivará en conversaciones más ricas o en un caos visual que desvíe la atención de los temas literarios hacia el contenido multimedia por sí mismo.
6. **Frecuencia de uso:** No sabemos cuántos usuarios regresan a la app específicamente para ver si les contestaron un comentario.
7. **Punto Exacto de Abandono en el CCI:** Desconocemos si el mayor abandono ocurre en el paso de realizar la transferencia bancaria o en el de subir el comprobante, lo cual determina qué parte del flujo optimizar primero.
8. **Efecto de las Insignias en Usuarios No Competitivos:** No sabemos si un sistema de badges literarios generará motivación adicional de forma universal o si podría generar el efecto contrario en usuarios que no leen grandes volúmenes de libros, haciéndolos sentir inferiores al compararse con usuarios con más insignias.
...
4. **Vitrina Literaria Pública en el Perfil:** Añadir una sección visible en el perfil de cada usuario que exponga su historial de "Libros Leídos", actuando como un portafolio literario social que incremente el sentido de identidad y pertenencia a la plataforma.
...
6. **Notificación Push de Carrito Abandonado:** Enviar una notificación push personalizada cuando un usuario haya iniciado el checkout pero no haya completado la compra en las siguientes 24 horas, con un mensaje contextual que mencione el título del libro pendiente.
7. **Modo Oscuro:** Implementar dark mode para sesiones de búsqueda de nuevas lecturas e interacciones sociales prolongadas.
8. **Insignias de Logros Literarios en el Perfil:** Incorporar un sistema de badges desbloqueables ("Primera Reseña Publicada", "10 Libros Leídos", "Miembro Activo de Comunidad") visibles en el perfil público, añadiendo un componente de gamificación a la identidad literaria.
...
3. **Multiplicación de Señales de Preferencia con el Tinder Literario:** Transformar las recomendaciones en una mecánica de swipe reducirá el tiempo de decisión por libro de varios segundos (entrar a ficha técnica → leer sinopsis → marcar favorito) a menos de 2 segundos por tarjeta, multiplicando el volumen de datos de preferencia disponibles para el algoritmo en cada sesión.
4. **Fidelización mediante Identidad Literaria Pública:** Permitir a los usuarios exhibir su historial de libros leídos y reseñas convertirá al perfil en un activo de orgullo personal, incrementando las visitas diarias a la plataforma motivadas no solo por la compra sino por la construcción y consulta de la propia identidad literaria.
5. **Revitalización del Engagement Social con GIFs:** La incorporación de GIFs animados en los posts y comentarios de las comunidades romperá la monotonía del texto plano y aumentará la frecuencia de publicaciones por usuario activo.
6. **El CCI es el Principal Punto de Abandono del Funnel de Ventas:** La mayor pérdida de usuarios ocurre en el paso de transferencia manual, y no en la selección del libro ni en el ingreso de datos del destinatario.
7. **Los Usuarios que Publican Reseñas tienen Mayor Retención:** Los usuarios que han posteado al menos una reseña tienen una probabilidad significativamente mayor de retornar a la plataforma, lo que valida la importancia de incentivar y visibilizar este comportamiento.
8. **Un Perfil Enriquecido Aumenta la Adopción de Comunidades:** Los usuarios con un historial literario visible en su perfil tienen mayor probabilidad de ser aceptados o invitados a comunidades por otros miembros, lo que refuerza el ciclo de retención social de la plataforma.
9. **La Mecánica de Swipe Mejora la Percepción del Motor de Recomendaciones:** Los usuarios perciben como más inteligente y personalizado un sistema que les pide retroalimentación activa mediante gestos rápidos que uno que presenta una cuadrícula estática sin indicación de cómo mejorar los resultados.
10. **Notificaciones Personalizadas:** Personalizar los mensajes de las notificaciones en base a las interacciones sociales y sus tendencias literarias hará que los usuarios ingresen más seguido a la plataforma.

---

### 8.1.3. Experiment-Ready Questions
Las preguntas listas para el experimento se organizan en dos tipos según su naturaleza epistemológica. Las **preguntas impulsadas por creencias** (*Belief-led*) parten de una premisa ya formulada sobre el comportamiento del usuario o el impacto de una funcionalidad, y buscan validarla o refutarla mediante evidencia. Las **preguntas exploratorias** operan en zonas donde el equipo no posee una creencia suficientemente formada y buscan mapear el terreno antes de diseñar un experimento con hipótesis direccional.
...
|---|---|---|---|
| BLQ01 | ¿Una interfaz completamente en español reduce el abandono durante el proceso de compra y mejora la tasa de completado del pago entre usuarios hispanohablantes? | Se cree que la barrera idiomática genera fricción cognitiva en pantallas de alta acción, elevando el abandono en los pasos de validación de datos y confirmación de pago. | Localización e internacionalización |
| BLQ02 | ¿Pre-rellenar automáticamente los datos del comprador (nombre, apellido, correo) con la información del perfil registrado reduce el tiempo de completado del formulario de compra en más de un 40%? | Se cree que solicitar al usuario datos que la plataforma ya posee es una fuente de fricción evitable que alarga innecesariamente el proceso de checkout. | Experiencia de compra y formularios |
| BLQ03 | ¿Una billetera virtual interna que permita pre-cargar fondos mediante una única transferencia incrementa significativamente la frecuencia de compra al eliminar el proceso de transferencia manual por cada pedido individual? | Se cree que la necesidad de realizar una transferencia bancaria y subir un comprobante por cada compra individual es el principal cuello de botella del embudo de ventas. | Método de pago y conversión |
| BLQ04 | ¿Los usuarios que tienen fondos disponibles en la billetera virtual realizan en promedio más de dos compras por sesión, comparado con el flujo de pago manual actual donde cada compra requiere una operación bancaria separada? | Se cree que la disponibilidad inmediata de fondos elimina la fricción de decisión en el momento del impulso de compra, aumentando el ticket por sesión. | Billetera Livria y comportamiento de compra |
| BLQ05 | ¿Un sistema de recomendaciones basado en tarjetas deslizables genera más señales de preferencia por sesión que la cuadrícula estática actual, donde el usuario debe entrar a cada ficha individual para expresar su interés o desinterés? | Se cree que una mecánica de deslizamiento instintiva reduce el costo de interacción por decisión, multiplicando el volumen de datos de preferencia disponibles para el algoritmo en cada sesión. | Motor de recomendaciones y engagement |
| BLQ06 | ¿El índice de clics sobre libros recomendados es significativamente mayor en usuarios que han marcado más de cinco favoritos, comparado con usuarios con menos de tres, validando que el algoritmo mejora con más señales de preferencia disponibles? | Se cree que el algoritmo de recomendaciones requiere un umbral mínimo de señales de entrada para generar sugerencias relevantes, y que por debajo de ese umbral el usuario percibe las recomendaciones como genéricas. | Motor de recomendaciones y personalización |
| BLQ07 | ¿Los usuarios que presionan el botón de actualizar recomendaciones tienen mayor probabilidad de agregar un libro al carrito en esa misma sesión, comparado con los usuarios que no lo utilizan? | Se cree que el uso activo del botón de actualización es un indicador conductual de intención de compra elevada, y no simplemente un gesto de exploración pasiva. | Recomendaciones y señales de intención de compra |
| BLQ08 | ¿Los libros con al menos tres reseñas publicadas tienen una tasa de adición al carrito mayor que los libros sin reseñas, indicando que el contenido generado por usuarios actúa como señal de confianza para la decisión de compra? | Se cree que la ausencia de reseñas genera incertidumbre en el usuario sobre la calidad del libro, elevando la barrera de compra especialmente en títulos de autores poco conocidos. | Reseñas y conversión |
| BLQ09 | ¿Los usuarios que publican su primera reseña dentro de los siete días posteriores a su primera compra tienen una tasa de retorno a la plataforma al mes de uso mayor que los usuarios que nunca han publicado una reseña? | Se cree que el acto de escribir una reseña genera un vínculo de compromiso con la plataforma que va más allá de la transacción, creando un hábito de participación que motiva el retorno. | Reseñas y retención |
| BLQ10 | ¿Un campo de reseña que incluye preguntas guía ("¿Qué te pareció el desenlace?", "¿A quién se lo recomendarías?") genera reseñas más detalladas y útiles que el campo de texto libre actual con placeholder genérico? | Se cree que los usuarios saben qué opinan sobre un libro pero no siempre saben cómo estructurar esa opinión en texto, y que las preguntas guía actúan como andamiaje que facilita la expresión escrita. | Reseñas y calidad de contenido |
| BLQ11 | ¿Los usuarios con más de diez libros marcados como favoritos tienen una tasa de conversión a compra mayor que los usuarios con menos de tres favoritos, o por el contrario los favoritos funcionan como lista de deseos sin intención de compra inmediata? | Se cree que el comportamiento de marcar favoritos es ambiguo: puede indicar alta intención de compra o simplemente colección pasiva, y es necesario determinar cuál de los dos patrones predomina para decidir cómo activar este segmento. | Favoritos y comportamiento de compra |
| BLQ12 | ¿Los usuarios que eligen recogida en tienda completan el proceso de pago con mayor frecuencia que los usuarios que eligen envío a domicilio, posiblemente porque evitan los pasos adicionales de selección de distrito, dirección y referencia? | Se cree que cada campo adicional en un formulario de envío representa una fricción incremental que aumenta la probabilidad de abandono antes de la confirmación del pedido. | Opciones de entrega y abandono de checkout |
| BLQ13 | ¿La tasa de abandono en el paso de pago es mayor en sesiones iniciadas después de las diez de la noche, cuando las aplicaciones bancarias presentan mayor latencia o el usuario no desea realizar una transferencia a esa hora? | Se cree que el método de pago por transferencia bancaria manual crea una dependencia del horario y la disponibilidad del servicio bancario del usuario, introduciendo una variable externa de abandono que no existe en métodos de pago integrados. | Pago y fricción externa |
| BLQ14 | ¿Los usuarios que utilizan el botón de copia del número de cuenta tienen mayor tasa de completado del pago que los usuarios que lo copian manualmente, porque el botón reduce el riesgo de error y la interrupción de flujo? | Se cree que el error en el copiado del número de cuenta es una causa silenciosa de transferencias fallidas que el usuario atribuye a la plataforma y no a su propio error, generando frustración y abandono. | Pago y usabilidad |
| BLQ15 | ¿El costo de envío es un factor determinante en el abandono del proceso de compra, con una tasa de abandono significativamente mayor en usuarios de zonas con tarifa de envío más elevada? | Se cree que revelar el costo de envío solo después de que el usuario ha ingresado su distrito genera una sensación de sorpresa negativa que en algunos segmentos supera el umbral de tolerancia de costo y provoca abandono. | Costos de envío y conversión |
| BLQ16 | ¿La tasa de participación activa en comunidades (publicaciones y comentarios) es mayor en comunidades de géneros populares como ficción y manga que en géneros de nicho como libros electrónicos o infantil, sugiriendo que la masa crítica de miembros es más determinante que el interés temático? | Se cree que la percepción de que "hay gente activa aquí" es un prerequisito para que un usuario nuevo se anime a publicar por primera vez, creando un efecto de red donde las comunidades grandes crecen más rápido que las pequeñas. | Comunidades y efecto de red |
| BLQ17 | ¿Los usuarios que fundan una comunidad tienen un tiempo de sesión semanal mayor que los usuarios que solo se unen a comunidades existentes, porque el sentido de propiedad genera una motivación intrínseca de retorno para ver la actividad de su comunidad? | Se cree que crear algo dentro de una plataforma genera un vínculo de inversión que no existe en el consumo pasivo, y que este vínculo se manifiesta en mayor frecuencia de visita y mayor nivel de contribución de contenido. | Comunidades y retención de creadores |
| BLQ18 | ¿Las publicaciones que incluyen imagen adjunta reciben más comentarios que las publicaciones de texto plano en las comunidades, indicando que el contenido visual actúa como mayor detonador de conversación que el texto solo? | Se cree que el contenido visual genera una reacción emocional más inmediata que el texto, reduciendo la barrera de respuesta para usuarios que de otro modo no sabrían cómo iniciar un comentario sobre un párrafo escrito. | Comunidades y multimedia |
| BLQ19 | ¿Habilitar el soporte de GIFs animados en publicaciones y comentarios de comunidades incrementa la proporción de usuarios que pasan de espectadores a creadores de contenido, al ofrecer un formato de expresión de menor costo cognitivo que la escritura de texto? | Se cree que una parte del segmento que actualmente solo lee sin publicar no lo hace por falta de opinión, sino por no encontrar un formato de expresión que se alinee con su estilo de comunicación digital. | Comunidades y expresividad |
| BLQ20 | ¿El proceso de pago de la suscripción al plan de comunidades tiene una tasa de abandono mayor que el proceso de pago de libros, dado que el valor percibido de la suscripción es menos inmediato y tangible que el de recibir un libro físico? | Se cree que la disposición a pagar mediante transferencia manual varía según la tangibilidad del bien adquirido, y que los servicios de suscripción digital presentan mayor resistencia que los productos físicos al requerir el mismo esfuerzo de pago. | Suscripción y fricción de conversión |
| BLQ21 | ¿Los usuarios que actualizan su foto de perfil dentro de los primeros tres días de registro tienen mayor tasa de retención al mes, indicando que la personalización temprana genera un sentido de pertenencia que motiva el retorno? | Se cree que la identidad visual dentro de una plataforma social actúa como ancla de compromiso: un usuario que ha invertido en crear una presencia reconocible tiene mayor probabilidad de volver a proteger esa inversión. | Perfil e identidad |
| BLQ22 | ¿La adición de una sección pública de libros leídos y reseñas en el perfil de usuario incrementa las visitas entre perfiles dentro de una misma comunidad, convirtiendo al perfil en un punto de descubrimiento literario social? | Se cree que los usuarios buscan referencias culturales en sus pares y que un historial literario visible funciona como una recomendación implícita, generando tráfico orgánico entre perfiles sin necesidad de un sistema de seguimiento explícito. | Perfil e identidad literaria |
| BLQ23 | ¿Un sistema de insignias desbloqueables por logros literarios visibles en el perfil público incrementa la frecuencia de visita diaria al generar un ciclo de recompensa por acciones específicas dentro de la plataforma? | Se cree que la ludificación de logros introduce una capa de motivación extrínseca que complementa el interés intrínseco en la lectura, especialmente efectiva para mantener el hábito de uso en períodos donde el usuario no tiene una compra inmediata en mente. | Perfil, gamificación y retención |
| BLQ24 | ¿La localización completa al español incrementa la exploración de funcionalidades avanzadas como comunidades, recomendaciones y exclusiones entre usuarios cuya lengua materna es el español, que actualmente podrían estar evitando estas secciones por no comprender sus etiquetas? | Se cree que la barrera idiomática no solo afecta el flujo de compra sino también el descubrimiento de funcionalidades secundarias, limitando el potencial de engagement de una porción significativa de la base de usuarios. | Localización y adopción de funcionalidades |
| BLQ25 | ¿Una notificación enviada veinticuatro horas después de un inicio de proceso de compra sin completar recupera al menos un diez por ciento de los usuarios que abandonaron el carrito, medido como compras completadas en las cuarenta y ocho horas siguientes a la notificación? | Se cree que el abandono del carrito en Livria no responde siempre a un rechazo definitivo del producto, sino frecuentemente a una interrupción externa (falta de tiempo para la transferencia bancaria, falta de saldo en ese momento) que una notificación oportuna puede reactivar. | Retención y recuperación de abandono |
| BLQ26 | ¿La incorporación de contenido editorial recurrente en las comunidades (como "Libro del mes" o "Pregunta semanal") mejora la relación entre usuarios activos diarios y mensuales al generar una razón externa de retorno más allá de la intención de compra? | Se cree que una plataforma que solo ofrece valor cuando el usuario quiere comprar un libro tiene un techo bajo de frecuencia de visita, y que la creación de momentos editoriales recurrentes en el módulo social puede romper ese techo. | Comunidades y fidelización |
| BLQ27 | ¿Una ficha de libro que presenta la sinopsis con mejor jerarquía visual, metadatos claros (número de páginas, año, editorial) y una sección de "lectores que también compraron" aumenta la tasa de adición al carrito respecto al diseño actual? | Se cree que una mayor cantidad de información contextual relevante en el momento de evaluación del libro reduce la incertidumbre del usuario y disminuye la necesidad de salir de la plataforma a buscar información adicional antes de decidir la compra. | Detalle del libro y conversión |
| BLQ28 | ¿La visibilidad del saldo disponible en la billetera virtual desde la pantalla del catálogo de libros reduce la fricción de decisión de compra al eliminar la necesidad de calcular si se cuenta con fondos suficientes antes de proceder? | Se cree que la transparencia del saldo disponible transforma la percepción del gasto: el usuario que ve su saldo disponible percibe la compra como uso de fondos ya comprometidos, psicológicamente distintos del dinero en su cuenta bancaria. | Billetera Livria y psicología de compra |
| BLQ29 | ¿Los usuarios que pertenecen a más de dos comunidades simultáneamente tienen una tasa de compra mensual mayor que los usuarios que no pertenecen a ninguna, sugiriendo que la participación social en la plataforma tiene un efecto positivo sobre el comportamiento transaccional? | Se cree que la inversión social en una plataforma (identidad, relaciones, reputación dentro de comunidades) genera un costo de salida que incrementa la lealtad transaccional, de modo que usuarios más socialmente integrados son también mejores compradores. | Comunidades y comportamiento de compra |
...
|---|---|---|---|
| EXQ01 | ¿En qué orden navegan los usuarios las secciones principales de Livria durante su primera sesión, y ese orden cambia entre la primera y la quinta sesión a medida que el usuario se familiariza con la plataforma? | Se desconoce si los usuarios descubren las funcionalidades avanzadas (comunidades, recomendaciones) por exploración espontánea o solo si son dirigidos explícitamente. | Onboarding y descubrimiento de funcionalidades |
| EXQ02 | ¿Cuánto tiempo permanece en promedio un libro en el carrito antes de ser eliminado sin compra, y ese tiempo varía según el precio del libro, el género o si el usuario tiene o no historial de compras previas? | Se desconoce si el abandono del carrito responde a una reconsideración del valor del libro, a una interrupción externa o a una barrera técnica del proceso de pago que el usuario no logra superar en ese momento. | Carrito y comportamiento de abandono |
| EXQ03 | ¿Qué día de la semana y franja horaria concentra el mayor volumen de intentos de inicio de proceso de compra, y esa distribución coincide con los horarios de mayor disponibilidad bancaria para la transferencia manual? | Se desconoce si existe un desajuste entre el momento en que el usuario quiere comprar y el momento en que puede ejecutar el pago, lo cual determinaría si la fricción del método de pago es temporal (horario) o estructural (proceso). | Pago y contexto temporal de compra |
| EXQ04 | ¿Qué géneros literarios concentran la mayor cantidad de libros marcados como favoritos y excluidos en la base de usuarios actual, y esa distribución coincide con los géneros de las comunidades más activas? | Se desconoce si las preferencias declaradas mediante favoritos se alinean con los géneros donde los usuarios buscan interacción social, o si son dimensiones independientes del comportamiento del lector. | Preferencias literarias y comportamiento social |
| EXQ05 | ¿Con qué frecuencia visitan los usuarios el perfil de otros lectores desde las secciones de comunidades o reseñas de libros, y qué acciones realizan típicamente después de visitar un perfil ajeno (unirse a una comunidad, explorar el catálogo, no hacer nada)? | Se desconoce si existe tráfico orgánico entre perfiles que justifique invertir en enriquecerlos, o si el perfil es percibido actualmente como un destino sin valor de visita para terceros. | Perfil y exploración social |
| EXQ06 | ¿Qué tipo de contenido comparten actualmente los usuarios en las publicaciones de comunidades que ya admiten imagen estática: capturas de páginas de libros, portadas, contenido personal sin relación literaria, o memes de cultura de lectura? | Se desconoce si el contenido multimedia que los usuarios publicarían de forma natural enriquece el debate literario o lo desviaría hacia el entretenimiento general sin relación con los libros, lo cual determinaría las políticas de moderación de la funcionalidad de GIFs. | Comunidades y naturaleza del contenido multimedia |
| EXQ07 | ¿Los usuarios que publican reseñas de libros tienden a pertenecer a más comunidades que los usuarios que solo compran, o son segmentos comportamentales distintos con patrones de engagement independientes? | Se desconoce si existe un perfil único de "usuario altamente comprometido" que concentra toda la actividad de valor (compras, reseñas, participación en comunidades), o si cada tipo de engagement corresponde a un segmento diferente con motivaciones distintas. | Reseñas, comunidades y segmentación de usuarios |
| EXQ08 | ¿Qué monto de recarga inicial consideraría razonable el usuario peruano promedio para depositar en una billetera virtual literaria antes de realizar sus primeras compras, y esa disposición varía según el historial de compras previas en la plataforma? | Se desconoce el umbral de confianza que un usuario nuevo en Livria necesita superar antes de estar dispuesto a inmovilizar dinero en una billetera digital interna de una plataforma que aún no conoce bien. | Billetera Livria y confianza del usuario |
| EXQ09 | ¿Los usuarios que son bloqueados por el muro de pago del plan de comunidades regresan a intentar suscribirse en sesiones futuras, y cuántas exposiciones al bloqueo ocurren en promedio antes de que el usuario tome la decisión de suscribirse o de abandonar definitivamente la funcionalidad? | Se desconoce si el interés inicial en las comunidades persiste a lo largo del tiempo tras el rechazo del muro de pago, o si el bloqueo genera una percepción negativa permanente que desactiva el interés incluso después de que el usuario podría permitírselo económicamente. | Paywall de comunidades y conversión diferida |
| EXQ10 | ¿Los usuarios que marcan libros como leídos dentro de la plataforma incluirían también títulos que no compraron en Livria (leídos en otras plataformas o en formato físico), o la adopción de la función dependería exclusivamente de la integración automática con el historial de compras? | Se desconoce si el usuario percibe el historial de lecturas como un registro personal de toda su vida lectora o exclusivamente como un reflejo de su actividad transaccional en Livria, lo cual determina el alcance y la propuesta de valor de la funcionalidad. | Vitrina literaria y alcance de la funcionalidad |
| EXQ11 | ¿Cuál es el tamaño de comunidad a partir del cual los usuarios nuevos se sienten motivados a publicar su primer post, y existe un umbral de masa crítica de miembros activos por debajo del cual los nuevos miembros prefieren solo leer sin contribuir? | Se desconoce si el engagement en comunidades sigue una distribución de ley de potencia (pocas comunidades grandes concentran toda la actividad) o si es posible mantener comunidades pequeñas activas mediante mecánicas de diseño específicas. | Comunidades y dinámica de participación |
...
|---|---|---|
| **Who** | ¿Quiénes abandonan con mayor frecuencia el proceso de pago — los usuarios en su primera compra o los usuarios con historial de compras previas en Livria? | Si el abandono se concentra en primeras compras, el problema es la curva de aprendizaje del proceso; si afecta a usuarios recurrentes, el problema es la fricción estructural del método en sí. |
| **What** | ¿Qué parte específica del proceso genera más abandono — el paso de realizar la transferencia bancaria o el paso de fotografiar y subir el comprobante? | Si el abandono ocurre mayoritariamente en la subida del comprobante (y no en la transferencia), una solución de verificación automática bancaria podría ser más efectiva que una billetera completa. |
| **Where** | ¿Desde qué aplicación bancaria realizan exitosamente la transferencia los usuarios que sí completan la compra, y difiere del banco de los usuarios que abandonan? | La tasa de éxito puede variar según la app bancaria del usuario, indicando que algunas aplicaciones bancarias introducen más fricción de interfaz que otras durante el proceso de transferencia. |
| **When** | ¿El abandono en el pago se concentra en franjas horarias nocturnas o en fines de semana, cuando los bancos tienen mayor tiempo de procesamiento o el usuario no dispone de tiempo para completar la operación? | Si existe una concentración temporal clara, mostrar un aviso de "mejor momento para realizar la transferencia" podría reducir abandonos sin cambiar el método de pago, representando una solución de menor costo técnico. |
| **Why** | ¿Por qué el usuario llega hasta el paso de instrucciones de pago sin completarlo — qué expectativa tenía sobre el método de pago que la pantalla no cumplió? | El usuario puede haber llegado al paso de pago esperando encontrar opciones de tarjeta o pasarela digital, y la presentación del CCI como único método lo sorprende negativamente cuando ya había invertido tiempo en el proceso. |
...
| Dimensión | Pregunta generada | Premisa oculta revelada |
|---|---|---|
| **Who** | ¿Los usuarios pasivos en comunidades son principalmente usuarios nuevos que aún no han encontrado el momento para participar, o usuarios que llevan semanas activos en la plataforma y han establecido un patrón permanente de solo lectura? | Si la mayoría de espectadores son usuarios nuevos, una intervención de bienvenida que invite al primer post puede activarlos; si son usuarios consolidados en patrón pasivo, se necesita un rediseño de la propuesta de valor del módulo social. |
| **What** | ¿Qué contenido les falta a los usuarios para animarse a publicar por primera vez — un tema de conversación específico, un formato de expresión más accesible que el texto, o simplemente más miembros activos visibles que demuestren que la comunidad está viva? | El activador de la primera publicación puede ser editorial (tema), expresivo (formato como GIFs) o social (masa crítica), y cada uno requiere una solución de diseño diferente. |
| **Where** | ¿Los usuarios pasivos consumen contenido en comunidades grandes con muchos miembros o en comunidades pequeñas donde su ausencia de publicación es más notoria? | Si los espectadores se concentran en comunidades pequeñas, el problema puede ser la ausencia de modelos de rol activos (pocos posts que imitar), no la falta de motivación o formato. |
| **When** | ¿Los posts de comunidad se generan mayoritariamente cerca del momento de unirse (entusiasmo inicial) o semanas después de la incorporación (integración gradual tras un período de observación)? | Si los primeros posts ocurren semanas después de unirse, los usuarios necesitan un período de observación antes de sentirse cómodos para publicar, y una intervención prematura de activación podría generar rechazo. |
| **Why** | ¿Por qué el usuario paga por un plan de acceso a comunidades y luego no participa activamente — percibe el valor del plan en leer el contenido de otros, o compró el acceso con intención de participar pero encuentra barreras no anticipadas al intentar hacerlo? | Si el usuario está satisfecho siendo espectador y ese era su caso de uso real, optimizar para aumentar la publicación puede ser un objetivo equivocado; el valor del producto puede estar en la lectura de comunidad, no en la creación de contenido. |
| **How** | ¿Cómo descubren los usuarios actualmente los temas de conversación dentro de una comunidad — leen todos los posts desde el más reciente, buscan por palabras clave, o entran directamente a los posts que aparecen en la vista principal sin exploración adicional? | Si los usuarios solo ven los posts más recientes sin explorar el hilo completo, una funcionalidad de "posts destacados de la semana" podría aumentar el descubrimiento de conversaciones valiosas y elevar la probabilidad de que un espectador encuentre un hilo en el que quiera opinar. |
...
| Criterio | 1 | 2 | 3 |
|---|---|---|---|
| **Confianza** | Baja certeza de que la pregunta tiene respuesta accionable | Certeza moderada | Alta certeza de que responderla genera una decisión clara |
| **Riesgo** | Ignorarla tiene bajo costo | Ignorarla puede generar pérdidas moderadas | Ignorarla puede hundir una funcionalidad crítica o el embudo de ventas |
| **Impacto** | Afecta una funcionalidad secundaria | Afecta retención o engagement | Afecta conversión, ingresos o viabilidad del producto |
| **Interés** | Baja relevancia estratégica inmediata | Relevancia media | Relevancia estratégica alta en el ciclo actual |

---

#### Backlog Broad (Preguntas exploratorias — mapeo de territorio desconocido)

| Prioridad | ID | Pregunta | Tipo | Por qué se investiga | Confianza | Riesgo | Impacto | Interés | Total |
|---|---|---|---|---|---|---|---|---|---|
| 1 | EXQ03 | ¿Qué día de la semana y franja horaria concentra el mayor volumen de intentos de compra, y esa distribución coincide con los horarios de disponibilidad bancaria? | Broad | Si existe desajuste entre el momento de intención de compra y la disponibilidad bancaria del usuario, la fricción del método de pago es temporal y resoluble con soluciones de bajo costo técnico (avisos o recordatorios), sin necesidad de rediseñar el flujo completo. | 3 | 3 | 3 | 3 | **12** |
| 2 | EXQ02 | ¿Cuánto tiempo permanece en promedio un libro en el carrito antes de ser eliminado sin compra, y ese tiempo varía según el precio, el género o el historial de compras? | Broad | Sin saber si el abandono del carrito es por reconsideración del valor, interrupción externa o barrera técnica, cualquier intervención de recuperación puede atacar la causa equivocada y resultar ineficaz. | 3 | 3 | 3 | 2 | **11** |
| 3 | EXQ08 | ¿Qué monto de recarga inicial consideraría razonable el usuario peruano promedio para depositar en una billetera virtual literaria, y esa disposición varía según el historial de compras previas? | Broad | Lanzar la billetera Livria sin saber el umbral de confianza financiera del usuario nuevo puede resultar en tasas de activación mínimas que invaliden la funcionalidad completa, cuyo desarrollo tiene alto costo técnico. | 2 | 3 | 3 | 3 | **11** |
| 4 | EXQ09 | ¿Los usuarios bloqueados por el muro de pago de comunidades regresan a suscribirse en sesiones futuras, y cuántas exposiciones al bloqueo ocurren antes de decidir? | Broad | Si el bloqueo genera percepción negativa permanente, el diseño actual del paywall puede estar destruyendo demanda potencial en lugar de convertirla, afectando el ingreso del plan de suscripción. | 2 | 3 | 3 | 3 | **11** |
| 5 | EXQ12 | ¿Qué porcentaje de usuarios en el catálogo usa búsqueda por texto para un título específico versus navega exploratoramente sin un libro concreto en mente? | Broad | Determina si la prioridad de inversión debe ser el motor de búsqueda o la navegación por filtros y categorías; una inversión en la dirección equivocada tiene alto costo de oportunidad. | 3 | 2 | 3 | 3 | **11** |
| 6 | EXQ01 | ¿En qué orden navegan los usuarios las secciones principales durante su primera sesión, y ese orden cambia entre la primera y la quinta sesión? | Broad | Si los usuarios no descubren funcionalidades avanzadas (comunidades, recomendaciones) de forma espontánea, el onboarding actual subestima su rol y el valor del producto permanece oculto para la mayoría de usuarios nuevos. | 2 | 2 | 3 | 3 | **10** |
| 7 | EXQ07 | ¿Los usuarios que publican reseñas tienden a pertenecer a más comunidades, o son segmentos comportamentales distintos con patrones independientes? | Broad | Si existe un único perfil de "usuario de alto valor" que concentra toda la actividad, las estrategias de adquisición y retención deben apuntar a ese segmento; si son segmentos distintos, requieren intervenciones diferenciadas. | 2 | 2 | 3 | 3 | **10** |
| 8 | EXQ11 | ¿Cuál es el tamaño de comunidad a partir del cual los usuarios nuevos se sienten motivados a publicar su primer post? | Broad | Si existe un umbral de masa crítica, las comunidades pequeñas son estructuralmente inviables sin intervención de diseño específica, lo que afecta la estrategia de crecimiento del módulo social. | 2 | 2 | 3 | 3 | **10** |
| 9 | EXQ05 | ¿Con qué frecuencia visitan los usuarios el perfil de otros lectores desde comunidades o reseñas, y qué acciones realizan después? | Broad | Antes de invertir en enriquecer los perfiles públicos, es necesario saber si existe tráfico orgánico entre perfiles que justifique el desarrollo o si el perfil es un destino sin valor de visita para terceros. | 2 | 2 | 2 | 3 | **9** |
| 10 | EXQ04 | ¿Qué géneros concentran la mayor cantidad de libros marcados como favoritos y excluidos, y esa distribución coincide con los géneros de las comunidades más activas? | Broad | Si las preferencias declaradas mediante favoritos no se alinean con los géneros de mayor actividad social, el algoritmo de recomendaciones y el diseño de comunidades están respondiendo a señales desconectadas entre sí. | 2 | 2 | 2 | 2 | **8** |
| 11 | EXQ10 | ¿Los usuarios que marcan libros como leídos incluirían títulos comprados fuera de Livria, o la adopción depende de la integración automática con el historial de compras? | Broad | Define el alcance y la propuesta de valor de la vitrina literaria antes de invertir en su desarrollo; si el usuario solo espeja compras en Livria, la funcionalidad tiene menor diferenciación competitiva. | 2 | 2 | 2 | 2 | **8** |
| 12 | EXQ06 | ¿Qué tipo de contenido comparten actualmente los usuarios en publicaciones con imagen estática: páginas de libros, portadas, memes de lectura o contenido personal sin relación literaria? | Broad | Determina las políticas de moderación antes de habilitar GIFs animados; si el contenido actual ya se desvía del tema literario, habilitar GIFs amplificaría esa tendencia y alteraría la identidad de las comunidades. | 2 | 1 | 2 | 2 | **7** |


#### Backlog Deep (Preguntas Belief-led — validación de creencias con hipótesis direccional)

| Prioridad | ID | Pregunta | Tipo | Por qué se investiga | Confianza | Riesgo | Impacto | Interés | Total |
|---|---|---|---|---|---|---|---|---|---|
| 1 | BLQ03 | ¿Una billetera virtual interna que permita pre-cargar fondos mediante una única transferencia incrementa significativamente la frecuencia de compra al eliminar la transferencia manual por pedido? | Deep | La transferencia bancaria manual por cada compra es el principal sospechoso del embudo roto; si esta creencia es incorrecta, el costo de desarrollo de la billetera no se justificaría y el equipo debe buscar la causa real del abandono. | 2 | 3 | 3 | 3 | **11** |
| 2 | BLQ13 | ¿La tasa de abandono en el paso de pago es mayor en sesiones iniciadas después de las 10 PM, cuando las apps bancarias presentan mayor latencia o el usuario no desea realizar una transferencia a esa hora? | Deep | Si el abandono tiene patrón horario claro, revelaría que la fricción es temporal y no estructural, permitiendo soluciones de bajo costo (avisos de mejor horario) antes de invertir en rediseño del flujo de pago completo. | 2 | 3 | 3 | 3 | **11** |
| 3 | BLQ15 | ¿El costo de envío es un factor determinante en el abandono, con tasa significativamente mayor en usuarios de zonas con tarifa más elevada? | Deep | Si la revelación tardía del costo de envío genera abandono, un cambio de UX (mostrar tarifas antes de que el usuario ingrese su distrito) puede recuperar conversiones sin modificar precios ni infraestructura logística. | 2 | 3 | 3 | 3 | **11** |
| 4 | BLQ01 | ¿Una interfaz completamente en español reduce el abandono durante el proceso de compra y mejora la tasa de completado del pago entre usuarios hispanohablantes? | Deep | La barrera idiomática en pantallas de alta acción (validación de datos, confirmación de pago) puede estar generando fricción cognitiva invisible en el segmento más amplio de usuarios, afectando la conversión global de la plataforma. | 3 | 2 | 3 | 3 | **11** |
| 5 | BLQ04 | ¿Los usuarios con fondos en la billetera virtual realizan en promedio más de dos compras por sesión, comparado con el flujo de pago manual actual? | Deep | Si la disponibilidad inmediata de fondos multiplica el ticket por sesión, la billetera se convierte en el principal palanca de crecimiento de ingresos, justificando priorizarla sobre otras funcionalidades en el roadmap. | 2 | 3 | 3 | 2 | **10** |
| 6 | BLQ20 | ¿El proceso de pago de la suscripción al plan de comunidades tiene mayor tasa de abandono que el pago de libros, dado que el valor percibido de la suscripción es menos tangible? | Deep | Si la suscripción enfrenta mayor resistencia de pago que los libros físicos con el mismo método de transferencia manual, el problema no es el método sino la propuesta de valor del plan, lo que requiere rediseñar los beneficios comunicados en el paywall. | 2 | 3 | 3 | 2 | **10** |
| 7 | BLQ25 | ¿Una notificación enviada 24 horas después de un proceso de compra iniciado sin completar recupera al menos un 10 % de los usuarios que abandonaron el carrito? | Deep | Si el abandono responde a interrupciones externas (falta de tiempo para la transferencia, falta de saldo momentánea) y no a rechazo del producto, las notificaciones de recuperación tienen alta tasa de retorno sin modificar el producto. | 2 | 2 | 3 | 3 | **10** |
| 8 | BLQ02 | ¿Pre-rellenar automáticamente los datos del comprador con la información del perfil registrado reduce el tiempo de completado del formulario de compra en más de un 40 %? | Deep | Solicitar datos que la plataforma ya posee es fricción evitable; si el pre-llenado reduce el tiempo en más del 40 %, representa una mejora de alta relación impacto/costo que debe priorizarse antes de rediseños mayores. | 3 | 2 | 3 | 2 | **10** |
| 9 | BLQ08 | ¿Los libros con al menos tres reseñas publicadas tienen una tasa de adición al carrito mayor que los libros sin reseñas? | Deep | Si el contenido generado por usuarios actúa como señal de confianza para la compra, la ausencia de reseñas en títulos nuevos es una barrera estructural de conversión que se puede intervenir con mecánicas de activación de primeras reseñas. | 3 | 2 | 3 | 2 | **10** |
| 10 | BLQ27 | ¿Una ficha de libro con mejor jerarquía visual, metadatos claros y sección de "lectores que también compraron" aumenta la tasa de adición al carrito respecto al diseño actual? | Deep | Si la incertidumbre del usuario sobre la calidad del libro lo lleva a salir de la plataforma a buscar información, el diseño actual de la ficha está transfiriendo tráfico a competidores en el momento de mayor intención de compra. | 2 | 2 | 3 | 3 | **10** |
| 11 | BLQ05 | ¿Un sistema de recomendaciones basado en tarjetas deslizables genera más señales de preferencia por sesión que la cuadrícula estática actual? | Deep | Si la mecánica de deslizamiento multiplica el volumen de datos de preferencia disponibles para el algoritmo, el motor de recomendaciones mejoraría más rápido para todos los usuarios, creando un efecto compuesto sobre la personalización. | 2 | 2 | 3 | 3 | **10** |
| 12 | BLQ28 | ¿La visibilidad del saldo disponible en la billetera virtual desde la pantalla del catálogo reduce la fricción de decisión de compra? | Deep | Si ver el saldo disponible transforma la percepción del gasto (de dinero nuevo a fondos ya comprometidos), mostrar el saldo en el catálogo puede incrementar la tasa de inicio de proceso de compra sin cambios en el flujo de pago. | 2 | 2 | 3 | 3 | **10** |
| 13 | BLQ12 | ¿Los usuarios que eligen recogida en tienda completan el proceso de pago con mayor frecuencia que los usuarios que eligen envío a domicilio? | Deep | Si la recogida en tienda tiene mayor tasa de completado por evitar los campos de dirección, se puede simplificar el flujo de envío a domicilio reduciendo campos, en lugar de eliminar la opción. | 3 | 2 | 2 | 3 | **10** |
| 14 | BLQ14 | ¿Los usuarios que utilizan el botón de copia del número de cuenta tienen mayor tasa de completado del pago que quienes lo copian manualmente? | Deep | Si el error en el copiado del CCI es una causa silenciosa de transferencias fallidas que el usuario atribuye a la plataforma, mejorar la usabilidad del botón de copia es una solución de costo casi nulo con impacto directo en la conversión. | 3 | 2 | 2 | 2 | **9** |
| 15 | BLQ06 | ¿El índice de clics sobre libros recomendados es significativamente mayor en usuarios con más de cinco favoritos comparado con usuarios con menos de tres? | Deep | Si el algoritmo requiere un umbral mínimo de señales para generar recomendaciones relevantes, es necesario diseñar una mecánica de onboarding que lleve rápidamente a cada usuario nuevo por encima de ese umbral. | 2 | 2 | 2 | 3 | **9** |
| 16 | BLQ09 | ¿Los usuarios que publican su primera reseña dentro de los siete días posteriores a su primera compra tienen mayor tasa de retorno al mes que quienes nunca han publicado? | Deep | Si la escritura de una reseña crea un hábito de participación que motiva el retorno, incentivar activamente la primera reseña post-compra se convierte en la palanca de retención más temprana y económica disponible. | 2 | 2 | 2 | 3 | **9** |
| 17 | BLQ17 | ¿Los usuarios que fundan una comunidad tienen mayor tiempo de sesión semanal que los usuarios que solo se unen a comunidades existentes? | Deep | Si el sentido de propiedad genera mayor frecuencia de visita, facilitar la creación de comunidades (reducir fricción de fundación) se convierte en una palanca de retención más potente que optimizar la experiencia de membresía pasiva. | 2 | 2 | 2 | 3 | **9** |
| 18 | BLQ29 | ¿Los usuarios que pertenecen a más de dos comunidades simultáneamente tienen una tasa de compra mensual mayor que los usuarios que no pertenecen a ninguna? | Deep | Si la integración social tiene efecto positivo sobre el comportamiento transaccional, el módulo de comunidades no es solo una funcionalidad de engagement sino un motor de conversión, lo que cambia su prioridad en el roadmap y sus métricas de éxito. | 2 | 2 | 2 | 3 | **9** |
| 19 | BLQ24 | ¿La localización completa al español incrementa la exploración de funcionalidades avanzadas como comunidades, recomendaciones y exclusiones entre usuarios hispanohablantes? | Deep | Si la barrera idiomática limita el descubrimiento de funcionalidades secundarias y no solo el flujo de compra, la localización tiene un ROI más amplio del que se asume actualmente, afectando el engagement general de la plataforma. | 2 | 2 | 2 | 2 | **8** |
| 20 | BLQ26 | ¿La incorporación de contenido editorial recurrente en las comunidades ("Libro del mes", "Pregunta semanal") mejora la relación entre usuarios activos diarios y mensuales? | Deep | Si la plataforma solo ofrece valor cuando el usuario quiere comprar, la frecuencia de visita tiene un techo bajo; los momentos editoriales recurrentes pueden elevar ese techo sin desarrollo técnico complejo. | 2 | 2 | 2 | 2 | **8** |
| 21 | BLQ16 | ¿La participación activa en comunidades es mayor en géneros populares como ficción y manga que en géneros de nicho, sugiriendo que la masa crítica es más determinante que el interés temático? | Deep | Si la masa crítica es más determinante que el interés temático, la estrategia de lanzamiento de nuevas comunidades debe concentrar usuarios en pocos géneros de alta demanda antes de diversificar, en lugar de lanzar todas las comunidades simultáneamente. | 2 | 2 | 2 | 2 | **8** |
| 22 | BLQ21 | ¿Los usuarios que actualizan su foto de perfil dentro de los primeros tres días de registro tienen mayor tasa de retención al mes? | Deep | Si la personalización temprana genera un sentido de pertenencia que ancla al usuario, el onboarding debe incluir un prompt explícito de personalización de perfil como paso crítico, no opcional. | 2 | 1 | 2 | 3 | **8** |
| 23 | BLQ10 | ¿Un campo de reseña con preguntas guía genera reseñas más detalladas y útiles que el campo de texto libre actual? | Deep | Si los usuarios saben qué opinan pero no cómo estructurarlo, las preguntas guía actúan como andamiaje que eleva la calidad del contenido generado sin aumentar el esfuerzo del usuario, mejorando la señal de confianza para futuros compradores. | 3 | 1 | 2 | 2 | **8** |
| 24 | BLQ07 | ¿Los usuarios que presionan el botón de actualizar recomendaciones tienen mayor probabilidad de agregar un libro al carrito en esa misma sesión? | Deep | Si el uso activo del botón de actualización es un indicador conductual de intención de compra elevada, puede usarse como señal de activación para mostrar ofertas o descuentos contextuales en el momento de mayor predisposición. | 2 | 1 | 2 | 3 | **8** |
| 25 | BLQ11 | ¿Los usuarios con más de diez favoritos tienen mayor tasa de conversión a compra, o los favoritos funcionan como lista de deseos sin intención de compra inmediata? | Deep | Si los favoritos funcionan mayoritariamente como colección pasiva, campañas de activación de "favoritos sin comprar" pueden reactivar un segmento ya comprometido con el catálogo con comunicación mínima. | 2 | 1 | 2 | 3 | **8** |
| 26 | BLQ22 | ¿Una sección pública de libros leídos y reseñas en el perfil incrementa las visitas entre perfiles dentro de una misma comunidad? | Deep | Si el historial literario visible funciona como recomendación implícita entre pares, el perfil se convierte en un canal de descubrimiento de libros sin necesidad de un sistema de seguimiento explícito, con alto valor a bajo costo de desarrollo. | 2 | 1 | 2 | 2 | **7** |
| 27 | BLQ18 | ¿Las publicaciones con imagen adjunta reciben más comentarios que las de texto plano en las comunidades? | Deep | Si el contenido visual reduce la barrera de respuesta para usuarios que no saben cómo iniciar un comentario sobre texto escrito, habilitar formatos visuales más ricos eleva la tasa de conversión de espectadores a creadores de contenido. | 2 | 1 | 2 | 2 | **7** |
| 28 | BLQ19 | ¿Habilitar soporte de GIFs animados en comunidades incrementa la proporción de usuarios que pasan de espectadores a creadores de contenido? | Deep | Si una parte del segmento pasivo no publica por falta de formato de expresión adecuado (no por falta de opinión), habilitar GIFs puede activar un segmento que el texto escrito no alcanza. | 2 | 1 | 2 | 2 | **7** |
| 29 | BLQ23 | ¿Un sistema de insignias desbloqueables por logros literarios visibles en el perfil público incrementa la frecuencia de visita diaria? | Deep | Si la gamificación introduce motivación extrínseca que complementa el interés intrínseco en la lectura, las insignias pueden mantener el hábito de uso en períodos sin intención de compra, elevando la frecuencia de visita de toda la base. | 2 | 1 | 2 | 2 | **7** |
...
| **Hypothesis** | Creemos que migrar la interfaz completa al español, priorizando checkout, catálogo y comunidades, mejorará en al menos 1 punto (escala Likert 1 a 5) la comprensión percibida de la interfaz y del proceso de pago, sin que los usuarios reporten textos en inglés durante su recorrido, frente a la versión en inglés. |
...
| **Hypothesis** | Creemos que reemplazar la cuadrícula estática por tarjetas deslizables logrará que los usuarios califiquen con un mínimo de 4/5 la agilidad e intuición del descubrimiento por swipe y perciban las recomendaciones resultantes como acordes a sus intereses (mínimo 4/5), frente a la cuadrícula actual. |
...
| **Hypothesis** | Creemos que permitir recargar fondos una sola vez y comprar con un solo toque logrará que al menos el 70% de los participantes declare disposición y seguridad para mantener saldo en la plataforma y perciba el pago con billetera como más rápido y sencillo (mínimo 4/5) que el flujo de transferencia por CCI repetitivo. |
...
| **Hypothesis** | Creemos que exponer públicamente el historial de libros leídos logrará que al menos el 60% de los usuarios califique con un mínimo de 4/5 que la vitrina motiva la interacción con la comunidad, o que califique con un mínimo de 4/5 el aporte de la vitrina a su identidad lectora, frente al perfil básico actual. |
...
| **Hypothesis** | Creemos que habilitar imágenes y GIFs en posts y comentarios logrará que al menos el 50% de los participantes califique con un mínimo de 4/5 la facilidad de adjuntar contenido y perciba las conversaciones de la comunidad como más expresivas y atractivas (mínimo 4/5), frente al composer de solo texto actual. |

### 8.2.1. Hypotheses

Las hipótesis permiten convertir las creencias del equipo en declaraciones comprobables mediante experimentos. En Livria, estas hipótesis no serán tratadas como verdades absolutas, sino como afirmaciones que deben ser puestas a prueba. Dado que la ronda de validación To-Be se ejecutó mediante un instrumento estructurado post-sesión (escala Likert), las hipótesis se formulan en términos de **percepción del usuario** (claridad, agilidad, facilidad, seguridad e identidad percibidas), dejando la confirmación conductual en producción como línea de trabajo posterior.

| ID | Pregunta asociada | Hipótesis de trabajo | Hipótesis nula | Medidas esperadas |
|---|---|---|---|---|
| H01 | BLQ01, BLQ24 | Si se migra la interfaz completa al español (es_419), priorizando checkout, catálogo y comunidades, entonces los usuarios hispanohablantes percibirán mayor claridad y comprensión de la interfaz y del proceso de pago, reduciendo la fricción idiomática percibida al usar la aplicación y sus funcionalidades. | La localización al español no generará diferencias relevantes en la claridad ni en la comprensión percibida de la interfaz y del proceso de pago frente a la interfaz actual en inglés. | Incremento de al menos 1 punto (Likert 1 a 5) en la comprensión percibida de la interfaz y del proceso de pago, sin cadenas en inglés reportadas durante el recorrido. |
| H02 | BLQ05 | Si se reemplaza la cuadrícula estática de recomendaciones por una mecánica de tarjetas deslizables (swipe), entonces los usuarios percibirán el descubrimiento de libros como más rápido e intuitivo y percibirán las recomendaciones resultantes como más acordes a sus intereses. | La mecánica de swipe no generará diferencias relevantes en la agilidad e intuición percibidas del descubrimiento ni en la percepción de pertinencia de las recomendaciones frente a la cuadrícula estática actual. | Calificación promedio ≥4/5 en la agilidad e intuición del descubrimiento por swipe y en la percepción de que las recomendaciones reflejan los intereses marcados. |
| H03 | BLQ03, BLQ04 | Si el usuario puede pre-cargar fondos en una billetera virtual mediante una única transferencia y pagar con un solo toque, entonces percibirá el proceso de pago como más rápido y sencillo que la transferencia por CCI y expresará disposición y seguridad para mantener saldo en la plataforma. | La billetera virtual no generará diferencias relevantes en la facilidad percibida del pago ni en la disposición a mantener saldo frente al flujo de pago manual actual. | Al menos 70% de los participantes declara disposición y seguridad para mantener saldo, junto con una percepción ≥4/5 de que pagar con billetera es más rápido y sencillo que la transferencia por comprobante. |
| H04 | BLQ22 | Si el perfil expone públicamente el historial de libros leídos, entonces el usuario percibirá una mayor identidad lectora y una mayor motivación para interactuar con la comunidad. | La vitrina literaria en el perfil no generará diferencias relevantes en la identidad lectora percibida ni en la motivación a interactuar con la comunidad frente al perfil básico actual. | Al menos 60% de los usuarios califica ≥4 que la vitrina motiva la interacción con la comunidad, o califica con un mínimo de 4/5 el aporte de "My Books" a su identidad lectora. |
| H05 | BLQ18, BLQ19 | Si se habilita el soporte de imágenes y GIFs en publicaciones y comentarios de comunidades, entonces los usuarios percibirán el proceso de adjuntar contenido como intuitivo y percibirán las conversaciones de la comunidad como más expresivas y atractivas. | El soporte de imágenes y GIFs no generará diferencias relevantes en la facilidad percibida de adjuntar contenido ni en la expresividad percibida de las conversaciones frente al composer de solo texto actual. | Al menos 50% de los participantes califica ≥4 la facilidad de adjuntar imágenes/GIFs, junto con una percepción ≥4/5 de que las conversaciones resultan más expresivas. |
...
Para mitigar el riesgo de basar decisiones en métricas de vanidad, Livria centra la validación de esta ronda experimental en métricas de percepción de usabilidad (extraídas del instrumento de validación post-sesión con usuarios), reservando las métricas de comportamiento automatizado (Google Analytics y Firebase Analytics) para la confirmación conductual en producción de una ronda posterior. Las *Experiment Cards* diseñadas por el equipo únicamente podrán hacer referencia a las métricas definidas en esta tabla; no se permitirán métricas ad-hoc.

| Métrica de Negocio | Fórmula de Cálculo / Origen | Técnica de Recolección | Meta Deseada |
|---|---|---|---|
| Facilidad y Confianza Percibidas de la Billetera | Promedio de las Preguntas 14 (rapidez/sencillez del pago con billetera) y 15 (seguridad para mantener saldo) del instrumento de validación, y proporción de participantes con calificación ≥4 en la Pregunta 15. | Formulario de validación post-sesión (escala 1 a 5). | Que al menos el 70% de los participantes califique con ≥4 la seguridad para mantener saldo y se obtenga un promedio ≥4/5 en la facilidad percibida del pago con billetera. |
| Agilidad Percibida del Descubrimiento por Swipe | Promedio de las Preguntas 8 (rapidez/intuición del swipe) y 10 (agilidad frente a otros métodos) del instrumento de validación. | Formulario de validación post-sesión (escala 1 a 5). | Obtener un promedio ≥4/5 en la agilidad e intuición percibidas del descubrimiento por swipe. |
| Facilidad Percibida de Adjuntar Contenido Multimedia | Promedio de las Preguntas 20 (facilidad de adjuntar imagen/GIF) y 22 (expresividad percibida) del instrumento, y proporción de participantes con calificación ≥4 en la Pregunta 20. | Formulario de validación post-sesión (escala 1 a 5). | Que al menos el 50% de los participantes califique ≥4 la facilidad de adjuntar contenido y se obtenga un promedio ≥4/5 en la expresividad percibida. |
...
Esta sección detalla los criterios seleccionados para recopilar la evidencia que permitirá responder la pregunta principal de cada experimento, así como detectar posibles efectos secundarios no deseados derivados de las modificaciones introducidas en la plataforma.

Siguiendo el principio de eficiencia metodológica, Livria adopta el enfoque **OMTM (One Metric That Matters)**, mediante el cual cada experimento es evaluado a partir de una **Medida Principal**, encargada de determinar el éxito o fracaso de la hipótesis, y una **Medida de Protección (Guardrail Metric)**, cuya finalidad es garantizar que las mejoras implementadas no degraden otras dimensiones relevantes de la experiencia del usuario. Las métricas serán monitoreadas únicamente durante el periodo necesario para alcanzar un nivel de confianza suficiente para la toma de decisiones.

| Experimento | Medida Principal (OMTM) | Propósito | Medida de Protección (Guardrail Metric) | Propósito |
|---|---|---|---|---|
| **Experimento 1: Localización Total al Español (H1)** | **Índice de Fricción en Checkout** | Determinar si la eliminación de la barrera idiomática reduce la confusión percibida durante el proceso de compra, utilizando la Pregunta 14 del instrumento de evaluación. | **Autonomía Percibida en la Tarea** | Verificar mediante la Pregunta 24 del formulario que la traducción de los llamados a la acción (CTAs) no reduzca la capacidad percibida del usuario de completar la tarea sin ayuda. |
| **Experimento 2: Tinder Literario / Swipe (H2)** | **Agilidad Percibida del Descubrimiento por Swipe** | Medir si la mecánica de deslizamiento se percibe como una forma rápida e intuitiva de descubrir libros, mediante las Preguntas 8 y 10 del instrumento de validación. | **Satisfacción de Sugerencias** | Confirmar, mediante la Pregunta 11 del formulario, que la facilidad para descartar libros no afecte negativamente la percepción de que las recomendaciones reflejan los intereses del usuario. |
| **Experimento 3: Billetera Livria (H3)** | **Facilidad y Confianza Percibidas de la Billetera** | Evaluar si el pago con saldo precargado se percibe como más rápido y sencillo que la transferencia con comprobante y si el usuario declara disposición y seguridad para mantener saldo (Preguntas 14 y 15). | **Tasa de Compra sin Errores con Billetera** | Asegurar, mediante la Pregunta 16 del formulario, que la incorporación de la billetera virtual no introduzca errores ni bloqueos que impidan completar la compra. |
| **Experimento 4: Vitrina Literaria en el Perfil (H4)** | **Tasa de Desinterés en Perfil** | Medir la disminución del desinterés hacia el perfil personal después de incorporar información relacionada con las preferencias literarias del usuario. | **Percepción de Identidad Lectora** | Analizar mediante la Pregunta 18 del formulario si la sección "My Books" es percibida como una representación genuina de la identidad lectora del usuario y no como un añadido sin valor. |
| **Experimento 5: Comentarios y Publicaciones con Imágenes/GIFs (H5)** | **Facilidad Percibida de Adjuntar Contenido Multimedia** | Determinar, mediante las Preguntas 20 y 22 del formulario, si adjuntar imágenes y GIFs se percibe como intuitivo y si eleva la expresividad percibida de las conversaciones. | **Legibilidad de Interfaz** | Verificar mediante la Pregunta 10 del formulario que la incorporación de imágenes y GIFs no afecte negativamente la claridad visual y la lectura de los contenidos. |
...
**Condición Experimental:** El perfil incorpora una estructura basada en pestañas públicas. La vista principal incluye una sección denominada "Vitrina Literaria", donde se muestra un carrusel con libros leídos recientemente.
...
La certeza define la tolerancia al riesgo del equipo de Livria al tomar una decisión de producto basada en los datos experimentales. Estos dos parámetros estadísticos rigen la fase de confirmación conductual en producción (pruebas A/B) y se fijan de forma estándar para todos los experimentos del MVP, alineados a los estándares de experimentación en la industria del software (Kohavi et al., 2020):
...
* **Poder Estadístico ($1 - \beta$):** Se define en **80%**. Este parámetro ayuda a evitar los errores de Tipo II (Falso Negativo), asegurando que si la nueva funcionalidad (como el *Swipe Literario* o la *Billetera Livria*) realmente genera un impacto positivo en el comportamiento de los usuarios, la prueba en producción tiene un **80%** de probabilidad de detectarlo exitosamente.

#### 2. Precisión (Granularidad del cambio a detectar)
La precisión se representa mediante el **Efecto Mínimo Detectable (MDE)**, el cual indica el tamaño de la diferencia que el negocio considera valiosa en la fase de confirmación conductual.

Dado que Livria se encuentra en una etapa de escalabilidad temprana, el equipo ha decidido establecer un MDE relativo del **10%** para variaciones en las tasas de conversión conductuales (como el checkout o la transición a creador) que se medirán en producción. Cualquier incremento inferior al **10%** no justifica el costo de ingeniería necesario para integrar, mantener y escalar la nueva funcionalidad a largo plazo. La validación perceptual de esta ronda, en cambio, no se decide por este MDE de conversión, sino por los umbrales de percepción definidos en las Experiment Cards (8.1.5) y en las Domain Business Metrics (8.2.2) —incremento de ≥1 punto Likert, promedios ≥4/5 y proporciones ≥60–70% según el experimento.

#### 3. Determinación de la Escala (Tamaño de Muestra)
Para determinar la cantidad de evidencia necesaria en la confirmación conductual (a cuántos usuarios debemos exponer al experimento en producción) sin incurrir en cálculos estadísticos manuales complejos, el equipo utilizará calculadoras estándar de pruebas A/B de la industria, introduciendo los parámetros de certeza y precisión previamente definidos (Significación 5%, Poder 80%, MDE 10%).

**Decisión Operativa de Livria:** Dado el contexto del proyecto, los *timeboxes* ágiles del MVP y el cronograma de entregas, la escala de recolección de evidencia se define según la naturaleza de la validación:

* **Validación de Percepción (Instrumento post-sesión):** Las cinco hipótesis de esta ronda se validan mediante el formulario post-sesión, por lo que se establece una escala fija de **10 a 15 participantes** por variante (Grupo A y Grupo B). Según los estándares de usabilidad (Nielsen, 2000), esta muestra es estadísticamente suficiente para revelar los patrones dominantes de validación y fricción percibida en la interfaz sin saturar los recursos operativos del equipo.
* **Confirmación Conductual Futura (Métricas de Firebase/GA):** Para la confirmación en producción de los efectos conductuales que esta ronda validó en percepción (como la *Billetera Livria* o el *Swipe Literario*), el experimento se ejecutará ininterrumpidamente por un período de **7 días calendario (un ciclo semanal completo)**. Este *timebox* es el mínimo metodológicamente aceptable, ya que garantiza capturar las variaciones de tráfico entre días laborables y el fin de semana, ajustándose a la ventana de tiempo del proyecto.
...
La ejecución de la investigación se apoya en dos métodos, elegidos por ser la vía más rápida y útil según el momento de validación:

* **Pruebas de Usabilidad Moderadas (Método Cualitativo de Percepción):** Para las cinco hipótesis de percepción del MVP (H1 a H5), el método técnico seleccionado en esta ronda es la sesión de navegación guiada complementada con el formulario de validación post-sesión. Esta es la técnica más simple y útil para capturar la percepción del usuario —claridad, agilidad, facilidad, seguridad e identidad percibidas— con la muestra cualitativa estipulada de 10 a 15 usuarios.
* **Pruebas A/B en Producción (Método Cuantitativo, confirmación futura):** Firebase Remote Config queda reservado para una ronda posterior de confirmación conductual en producción, asignando aleatoriamente a los usuarios al Grupo de Control o Experimental directamente desde la nube, sin necesidad de que descarguen una nueva actualización de las tiendas de aplicaciones. Su fin es contrastar en comportamiento real (señales de swipe por sesión, compras por sesión con billetera y conversión espectador→creador) los efectos que esta ronda validó en percepción.
...
|---|---|---|---|
| **Eliminar la barrera idiomática que genera abandono en pantallas de alta acción.** | Aumento de la comprensión percibida en el embudo de checkout. | **Índice de Fricción en Checkout** (Pregunta 14 del instrumento de validación, escala 1–5) y **Autonomía Percibida en la Tarea** (Pregunta 24, como guardrail). | La confusión idiomática no se detecta en el evento `purchase` por sí solo (es insensible al "por qué"), por lo que se mide con una métrica de percepción de bajo costo de recolección (un único ítem del formulario ya planificado), evitando instrumentar tracking de *hover* o tiempo de lectura por campo. |
| **Maximizar el volumen de señales de preferencia disponibles para el algoritmo de recomendaciones.** | Incremento en la agilidad e intuición percibidas del descubrimiento por swipe. | **Agilidad Percibida del Descubrimiento por Swipe** (Preguntas 8 y 10 del instrumento de validación). | Dos ítems ya planificados del formulario capturan la percepción del mecanismo sin instrumentar por separado cada gesto; son directamente comparables entre la condición de control y experimental sin normalización adicional. |
| **Reducir el cuello de botella del embudo de pagos causado por la transferencia manual repetitiva.** | Aumento de la facilidad y confianza percibidas del pago con saldo precargado. | **Facilidad y Confianza Percibidas de la Billetera** (Preguntas 14 y 15) y **Tasa de Compra sin Errores con Billetera** (Pregunta 16, como guardrail). | Las preguntas ya planificadas del formulario resuelven de forma económica el "por qué" de la disposición a mantener saldo, información que un evento de comportamiento por sí solo no captura; su sensibilidad es alta porque el efecto esperado (pago de un toque) se refleja directamente en la facilidad percibida declarada. |
| **Construir un componente de identidad social que incentive el retorno a la plataforma fuera del momento de compra.** | Reducción del desinterés hacia el perfil y aumento de la identidad lectora percibida. | **Tasa de Desinterés en Perfil** (Pregunta 17 del formulario) y **Percepción de Identidad Lectora** (Pregunta 18, como guardrail). | El desinterés hacia el perfil es una percepción que ningún evento de comportamiento captura de forma económica por sí solo (un usuario inactivo puede estarlo por desinterés o por desconocimiento); las preguntas ya planificadas resuelven la ambigüedad sin necesidad de encuestas adicionales. |
| **Elevar la riqueza expresiva de las comunidades para convertir espectadores en creadores de contenido.** | Incremento en la facilidad percibida de crear contenido multimedia. | **Facilidad Percibida de Adjuntar Contenido Multimedia** (Preguntas 20 y 22 del instrumento de validación). | Los ítems ya planificados del formulario aíslan de forma económica la percepción sobre el composer multimedia sin requerir un evento nuevo de "primera publicación", cuya conversión conductual real queda reservada a la confirmación en producción. |

#### Relación con las Métricas de Negocio y Medidas OMTM

Las métricas seleccionadas en esta tabla son las mismas que conforman el catálogo oficial de Domain Business Metrics (Sección 8.2.2) y las Medidas OMTM / Guardrail (Sección 8.2.3), todas ellas de percepción para esta ronda de validación. Esta sección no introduce indicadores nuevos: su propósito es hacer explícita la cadena de razonamiento que conecta cada meta de negocio del *As-Is Summary* con el KPI estratégico correspondiente, y de allí con la métrica concreta instrumentada en el formulario post-sesión. Esta trazabilidad evita que el equipo de Defontes mida por medir, asegurando que cada dato recolectado tiene un propósito de decisión claro: escalar, rediseñar o descartar la funcionalidad evaluada en el respectivo *Experiment Card*.

---

### 8.2.8. Web and Mobile Tracking Plan

Para Livria, el objetivo del *Tracking Plan* es estandarizar la captura de eventos en la aplicación móvil (Flutter) con el fin de sostener la **confirmación conductual en producción** del impacto de las cinco funcionalidades experimentales descritas en este capítulo (Localización al Español, Tinder Literario, Billetera Livria, Vitrina Literaria y Multimedia en Comunidades), evitando que la instrumentación quede dispersa o sea redundante con los eventos ya definidos en la Sección 6.2.2. La validación de esta ronda se realiza por percepción mediante el instrumento post-sesión; este plan de tracking prepara la medición del comportamiento real que dicha validación dejó pendiente.
...
Durante esta fase, el equipo instrumentó los nuevos eventos personalizados (*Custom Events*) que quedan listos para la confirmación conductual en producción de los cinco experimentos, y recolectó la línea base de percepción de la ronda To-Be mediante el instrumento post-sesión.
...
*Feedback de Usuarios:* A través del instrumento de validación post-sesión (Sección 6.3.1) se recogieron las medidas de percepción que sustentan la validación de las cinco hipótesis de esta ronda —comprensión percibida, agilidad del swipe, facilidad y confianza de la billetera, identidad lectora y facilidad de adjuntar contenido multimedia—, que no pueden capturarse mediante eventos de comportamiento.
...
| **Sprint Goal & User Stories** |  |
| Sprint 4 Goal | Our focus is on executing the To-Be experiments designed in Chapter VIII over a dedicated experimental version of the Livria platform. We believe that delivering the full Spanish localization (EP09), the swipe-based book discovery mechanic (EP10), the Livria Wallet payment method (EP11), the public literary showcase in the user profile (EP12) and image/GIF support in community posts and comments (EP13) will improve Spanish-speaking readers' perceived clarity, agility, ease, security and literary identity across checkout, discovery, payment, profile and communities. This will be confirmed when the experimental build exposes the five features end-to-end (Flutter client + .NET API on Azure) and the To-Be perception-validation interviews can be run against it. |
...
|---|---|---|---|---|---|
| Precisión percibida del motor de recomendaciones | **2.89/5** (peor de todo el instrumento As-Is) | 4.32/5 (recos reflejaron intereses) | **+1.43 pts (+49.5%)** | Recomendaciones acordes a intereses ≥4/5 | **Cumple (4.32 > 4.0)** |
| Confusión del apartado de recomendaciones | **3.11/5** (más confuso de la app) | Swipe intuitivo: 4.46/5 (invertido a claridad) | **Inversión total de la tendencia** | Agilidad e intuición percibida del swipe ≥4/5 | **Cumple (4.46 > 4.0)** |
| Uso continuado del mecanismo | N/A (no existía swipe) | 46.4% agotó la pila y recargó | Nueva métrica | Dato de uso declarado (fuera del criterio perceptual) | Complemento para confirmación en producción |

**Veredicto: Hipótesis de trabajo H02 VALIDADA.** El contraste es el más dramático de los cinco experimentos: el motor de recomendaciones pasó de ser **el punto más débil de toda la app** (peor precisión, mayor confusión) a obtener las calificaciones más altas del instrumento To-Be (4.32-4.46/5). Ambos criterios de percepción del Experiment Card 2 se cumplen con holgura: la agilidad e intuición percibidas del swipe alcanzan 4.46/5 y la percepción de que las recomendaciones reflejan los intereses del usuario llega a 4.32/5, ambas por encima del umbral de 4/5. Se rechaza la hipótesis nula. Como siguiente paso —ya no como condición de esta hipótesis—, se recomienda instrumentar la analítica de uso real (conteo de señales por sesión y tiempo de decisión) para cuantificar el efecto conductual, tal como recoge el backlog re-priorizado (BLQ06 y BLQ04).
...
|---|---|---|---|---|---|
| Localización del botón de crear publicación | **39.3%** (11 de 28) NO encontró el botón | Adjuntar imagen/GIF intuitivo: 4.43/5, **92.9%** calificó ≥4 | **Inversión de la tendencia** | ≥50% califica ≥4 la facilidad de adjuntar contenido | **Cumple (92.9% > 50%)** |
| Legibilidad de publicaciones/comentarios | 3.43/5 (21.4% calificó 1-2) | Expresividad percibida: 4.18/5 | **+0.75 pts** | Expresividad percibida ≥4/5 | **Cumple (4.18 > 4.0)** |
| Previsualización brinda control | No existía la función | 4.21/5 | Nueva métrica | — | Alto valor absoluto |

**Veredicto: Hipótesis de trabajo H05 VALIDADA.** El 92.9% de calificaciones positivas sobre la facilidad de adjuntar contenido es un contraste fuerte frente al 39.3% que ni siquiera encontraba el botón de publicar en el As-Is, y supera ampliamente el umbral de ≥50% del Experiment Card 5; la expresividad percibida de las conversaciones alcanza 4.18/5, también por encima de 4/5. Se rechaza la hipótesis nula. La conversión real espectador→creador —un efecto de comportamiento que la encuesta de percepción no captura— queda como línea de medición en producción y siguiente paso del backlog (BLQ18 y BLQ19), no como una condición pendiente de esta hipótesis.
...
| H02 — Swipe recomendaciones | **Validada** | Alta (ambos criterios de percepción superados; revierte el peor hallazgo del As-Is) |
...
| H05 — Imágenes/GIFs | **Validada** | Alta (facilidad y expresividad percibidas superan los umbrales) |

Ninguna de las cinco hipótesis nulas se sostiene con la evidencia recolectada: las cinco hipótesis de percepción quedan validadas contra su criterio de éxito. Cabe precisar que la validación de esta ronda es de percepción declarada; el efecto conductual real de las funcionalidades —número de señales de swipe por sesión, compras por sesión con billetera y conversión efectiva de espectador a creador— es una pregunta distinta y aún abierta, que el Question Backlog re-prioriza como siguiente fase de medición en producción (sección 8.4.2). La validación perceptual es sólida; la confirmación conductual es el paso que la complementa, no un requisito para dar por válidas estas hipótesis.
...
| Tinder Literario (H2) | Que la interacción por swipe se percibiría como una forma más ágil e intuitiva de descubrir libros y que las recomendaciones resultantes se sentirían más acordes a los intereses del usuario. | El módulo pasó de ser el peor evaluado del As-Is (2.89/5) al mejor del To-Be (4.32–4.46/5): la agilidad percibida y la pertinencia percibida de las recomendaciones superaron el umbral de 4/5. La percepción quedó validada; el efecto conductual (señales por sesión) es una medición aparte, todavía por instrumentar. | **Perseverar:** escalar la mecánica de swipe e instrumentar la analítica de uso real como siguiente fase (BLQ06, BLQ04). |
...
| Imágenes y GIFs (H5) | Que adjuntar contenido visual se percibiría como intuitivo y que ello haría sentir las conversaciones de la comunidad más expresivas y atractivas. | La facilidad percibida de adjuntar contenido llegó a 92.9% de calificaciones ≥4 y la expresividad percibida a 4.18/5, superando los umbrales. La percepción quedó validada; si esa facilidad se traduce en más usuarios publicando por primera vez (conversión espectador→creador) es un efecto conductual que requiere medición en producción. | **Perseverar:** escalar el composer multimedia, medir la conversión real como siguiente fase (BLQ18, BLQ19) y anticipar la moderación de contenido (EXQ06). |

**Aprendizajes transversales de la sesión:**

1. **La percepción no sustituye al comportamiento.** Las cinco validaciones de esta ronda descansan en percepción declarada; su contraparte conductual (señales de swipe por sesión, compras por sesión con billetera, tráfico real entre perfiles y conversión espectador→creador) queda pendiente de medición en producción. El equipo acordó que ningún experimento futuro se dará por cerrado sin esa contraparte de analítica conductual, decisión reflejada en la re-priorización de la sección 8.4.2.
...
7. Habiéndose validado perceptualmente el Experimento 2 (Tinder Literario) con el contraste más dramático del ciclo —cumpliendo ambos criterios de percepción del Experiment Card 2—, se recomienda instrumentar como siguiente paso la analítica de uso conductual sobre la mecánica de swipe (conteo real de señales de preferencia por sesión y tiempo de decisión) para cuantificar su impacto real en el comportamiento, tal como recoge el análisis de la sección 8.4.1 y el backlog re-priorizado (BLQ06 y BLQ04). Esta medición conductual no es una condición pendiente de la hipótesis ya validada, sino la fase que la complementa antes de escalar la funcionalidad a toda la base de usuarios.
...
| :--- | :--- | :--- |
| TB1 | Exposición TB1 — Livria | No se realizó video de exposición. |
...
| TF | Exposición TF — Livria | <https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201f855_upc_edu_pe/IQBw_qBEeCcfSKq2WEgUOrGyAZNQ3QUToRpMTkd5LK1vlDg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=8FMKt8> |
