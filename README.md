...
| **Experimento 4: Vitrina Literaria en el Perfil (H4)** | **Tasa de Desinterés en Perfil** | Medir la disminución del desinterés hacia el perfil personal después de incorporar información relacionada con el historial y las preferencias literarias del usuario. | **Percepción de Identidad Lectora** | Analizar mediante la Pregunta 18 del formulario si la sección "My Books" es percibida como una representación genuina de la identidad lectora del usuario y no como un añadido sin valor. |
